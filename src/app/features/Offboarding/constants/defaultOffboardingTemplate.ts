...
export const DEFAULT_OFFBOARDING_TEMPLATES: OffboardingTemplate[] = [
  {
    ...
    code: "ENG-OFF-01",
    description:
      "Full exit procedure including IT asset recovery, HR compliance, and Finance full & final settlement.",
    ...
    clearances: [
      {
        ...
        tasks: [
          {
            id: "ct1",
            name: "Revoke Email and Slack Access",
            owner: "IT Admin",
            isMandatory: true,
          },
          {
            id: "ct2",
            name: "Revoke GitHub and AWS Access",
            owner: "IT Admin",
            isMandatory: true,
          },
        ],
      },
      {
        ...
        tasks: [
          {
            id: "ct3",
            name: "Clear Pending Reimbursements",
            owner: "Finance Manager",
            isMandatory: true,
          },
          {
            id: "ct4",
            name: "Calculate Full & Final Settlement",
            owner: "Finance Manager",
            isMandatory: true,
          },
        ],
      },
      {
        ...
        tasks: [
          {
            id: "ct5",
            name: "Receive Handover Documents",
            owner: "Team Lead",
            isMandatory: true,
          },
          {
            id: "ct6",
            name: "Reassign Pending Tickets",
            owner: "Team Lead",
            isMandatory: true,
          },
        ],
