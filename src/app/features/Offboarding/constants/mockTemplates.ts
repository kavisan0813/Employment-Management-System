...
export const OFFBOARDING_MOCK_TEMPLATES: OffboardingTemplate[] = [
  {
    id: "mock-offboarding-engineering",
    name: "Reference: Engineering Exit",
    code: "OFF-ENG-001",
    description:
      "Reference company exit workflow with employee actions, asset recovery, and departmental sign-offs.",
    ...
    clearances: [
      {
        ...
        tasks: [
          {
            id: "handover",
            name: "Approve knowledge handover",
            owner: "Manager",
            isMandatory: true,
          },
        ],
      },
      {
        ...
        tasks: [
          {
            id: "access",
            name: "Revoke system access and confirm asset return",
            owner: "IT",
            isMandatory: true,
          },
        ],
      },
      {
        ...
        tasks: [
          {
            id: "settlement",
            name: "Verify final settlement inputs",
            owner: "Finance",
            isMandatory: true,
          },
        ],
    ...
    documents: [
      ...
      { id: "handover-notes", name: "Handover Notes", mandatory: true },
    ],
