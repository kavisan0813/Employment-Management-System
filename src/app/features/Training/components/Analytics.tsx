...
const bars = [45, 58, 43, 72, 65, 86, 78, 92];
    ...
    <section className="grid gap-4 lg:grid-cols-2">
      <div className="rounded-2xl border border-border bg-card p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold">Upcoming calendar</h2>
        </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold">Training completion</h2>
        </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold">Department participation</h2>
        </div>
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        <div className="flex items-center gap-2">
          <TrendingUp size={18} className="text-primary" />
          <h2 className="font-bold">Monthly training trend</h2>
        </div>
        <div className="mt-5 flex h-32 items-end gap-2">
          {[34, 42, 37, 60, 48, 76, 68, 84, 72, 95].map((height) => (
            <div
