...
export const P = {
  ...
  EMPLOYEES_DELETE: permissionKey(MODULES.EMPLOYEES, ACTIONS.DELETE),
  ...
  ONBOARDING_FINANCE_SETUP: permissionKey(
    MODULES.ONBOARDING,
    ACTIONS.FINANCE_SETUP,
  ),
  ONBOARDING_COMPLETE_TASKS: permissionKey(
    MODULES.ONBOARDING,
  ...
  ATTENDANCE_APPROVE_TEAM: permissionKey(
    MODULES.ATTENDANCE,
    ACTIONS.APPROVE_TEAM,
  ),
  ATTENDANCE_APPROVE_DEPT: permissionKey(
    MODULES.ATTENDANCE,
    ACTIONS.APPROVE_DEPT,
  ),
  ...
  PERFORMANCE_REVIEW_TEAM: permissionKey(
    MODULES.PERFORMANCE,
    ACTIONS.REVIEW_TEAM,
  ),
  PERFORMANCE_REVIEW_DEPT: permissionKey(
    MODULES.PERFORMANCE,
    ACTIONS.REVIEW_DEPT,
  ),
  ...
  EXPENSES_FINAL_APPROVAL: permissionKey(
    MODULES.EXPENSES,
