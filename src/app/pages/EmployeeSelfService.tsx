      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div className="bg-card p-6 rounded-[24px] border border-border shadow-sm hover:shadow-md transition-all relative group overflow-hidden">
          ...
          <div className="flex flex-col mt-3">
            <span className="text-[13px] font-bold text-muted-foreground mb-1">
              days remaining
            </span>
        ...
        >
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            <span className="px-2 py-0.5 rounded-full bg-primary/10 text-primary text-[10px] font-black border border-primary/20 uppercase tracking-tighter">
              Excellent
            </span>
          </div>
          <ArrowUpRight
          ...
          <div className="bg-primary rounded-[24px] p-6 text-white shadow-lg shadow-primary/20 relative overflow-hidden group cursor-pointer">
            ...
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((j) => (
                <div
                  key={j}
                  className="w-6 h-6 rounded-full border-2 border-primary bg-white/20 backdrop-blur-sm flex items-center justify-center text-[10px] font-bold text-white"
                >
                  +
                </div>
              ))}
