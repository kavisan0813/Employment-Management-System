...
const swapRequests = [
  {
    id: "SWP-001",
    from: "Sarah Johnson",
    fromRole: "Nurse Practitioner",
    fromDept: "Emergency",
    to: "Marcus Williams",
    toRole: "Nurse Practitioner",
    origin: "Morning",
    originDate: "Apr 7",
    requested: "Evening",
    requestedDate: "Apr 8",
  ...
  },
  {
    id: "SWP-002",
    from: "Ravi Kumar",
    fromRole: "Senior Surgeon",
    fromDept: "Surgical",
    to: "James Carter",
    toRole: "Senior Surgeon",
    origin: "Evening",
    originDate: "Apr 9",
    requested: "Morning",
  ...
  },
  {
    id: "SWP-004",
    from: "Robert Chen",
    fromRole: "Anesthesiologist",
    fromDept: "Surgical",
    to: "Priya Sharma",
    toRole: "Anesthesiologist",
    origin: "Morning",
    originDate: "Apr 6",
    requested: "Evening",
    requestedDate: "Apr 7",
  ...
  },
  {
    ...
    originDate: "Apr 13",
    requested: "Morning",
    requestedDate: "Apr 14",
    reason: "Educational Seminar",
  ...
  },
  {
    ...
    from: "Kevin Malone",
    fromRole: "Lab Tech",
    fromDept: "Diagnostics",
    to: "Oscar Martinez",
    toRole: "Lab Tech",
    origin: "Full Day",
    originDate: "Apr 15",
    requested: "Night",
    requestedDate: "Apr 16",
    reason: "Personal",
    submitted: "Today",
    status: "Pending",
  },
...
function OvertimeMonitoringReport({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 space-y-6">
      ...
      {/* Alert Banner */}
      <div
        className="rounded-2xl p-4 border-l-4 flex items-center justify-between"
        style={{
      ...
      <div className="grid grid-cols-5 gap-6">
        {/* Left: OT Trend */}
        <div
          className="col-span-3 rounded-2xl p-6 shadow-sm"
          style={{
        ...
        >
          ...
          <div className="h-[280px] relative">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart
                data={trendTab === "6 Weeks" ? otTrendData : otTrendMonthData}
              >
                <defs>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                {deptFilter === "All Departments" ? "Filter" : deptFilter}{" "}
                <ChevronDown size={14} />
              </button>
              {showFilterDropdown && (
            ...
            >
              {filteredEmployees.map((e, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-2 font-mono font-bold text-[#F59E0B]">
                    ₹{e.pay}
                  </td>
                  <td className="px-6 py-2">
                    <span
                  ...
                  <td className="px-6 py-2">
                    <div className="flex gap-1.5">
                      <button
                        className="w-8 h-8 rounded-full flex items-center justify-center bg-[var(--secondary)] text-[var(--muted-foreground)] hover:text-[var(--primary)] transition-all"
                        onClick={() => navigate("/schedule")}
                        title="View Schedule"
                      >
                        <Eye size={14} />
              ...
              {filteredEmployees.length === 0 && (
                <tr>
                  <td
                    colSpan={9}
                    className="px-6 py-10 text-center text-muted-foreground font-bold"
                  >
            ...
            <div className="flex-1 space-y-2">
              {otShiftData.map((s, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-[13px] font-bold text-[#0F3047]">
                      {s.hours}h
                    </span>
                    <span
                      className="px-2 py-0.5 rounded-full text-[11px] font-bold"
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              >
                <AlertTriangle size={14} /> ⚠️ Approaching monthly OT budget
                limit
              </p>
            </div>
          </div>
...
function ShiftSwapReport({ onBack }: { onBack: () => void }) {
  ...
  const handleExportCSV = () => {
    ...
    const rows = filtered.map((r) => [
      ...
      r.fromDept,
      r.to,
      `${r.origin} (${r.originDate})`,
      `${r.requested} (${r.requestedDate})`,
      r.reason,
      r.submitted,
      r.status,
    ]);
    ...
    <div className="w-full px-4 md:px-8 py-6 space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <KpiCard
          ...
          value={String(localRequests.length)}
          color="var(--primary)"
        />
        <KpiCard
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            >
              Swap Requests —{" "}
              {chartTab === "Week" ? "Last 4 Weeks" : "Last 4 Months"}
            </h3>
          ...
          <div className="h-[240px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={chartTab === "Week" ? swapTrendData : swapTrendMonthData}
                barGap={4}
              >
                <CartesianGrid
                  vertical={false}
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        ...
                        >
                          {req.originDate} ↔ {req.requestedDate}
                        </span>
                      </div>
                    </td>
                    <td
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        ...
                        {req.status === "Pending" && (
                          <button
                            className="p-1.5 rounded-lg font-bold text-[#059669] hover:bg-emerald-50 text-[11px]"
...
const reports = [
  ...
  {
    title: "Shift Swap Report",
    desc: "Detailed log of shift exchange requests",
    icon: Calendar,
    color: "#10B981",
    bg: "#ECFDF5",
    generated: "Today",
  ...
  },
  {
    ...
    desc: "Consolidated overtime tracking",
    icon: Clock,
    color: "#F59E0B",
    bg: "#FFFBEB",
    generated: "Today",
...
function HeadcountReport({ onBack }: { onBack: () => void }) {
  ...
  const statuses = [
    "All",
    ...Array.from(new Set(hcEmployees.map((e) => e.status))),
  ];
  const locations = [
    "All",
    ...
    <div className="w-full px-4 md:px-8 py-6">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <KpiCard
          ...
          value={String(hcEmployees.length)}
          color="#059669"
        />
        <KpiCard
          label="Active"
          value={String(
            hcEmployees.filter((e) => e.status === "Active").length,
          )}
          color="#22C55E"
        />
        <KpiCard
          label="On Leave"
          value={String(
            hcEmployees.filter((e) => e.status === "On Leave").length,
          )}
          color="#F59E0B"
        />
        <KpiCard
          label="Inactive"
          value={String(
            hcEmployees.filter((e) => e.status === "Inactive").length,
          )}
          color="#EF4444"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-5">
        {/* Table Section */}
        <div
          className="col-span-2 rounded-2xl shadow-sm overflow-hidden"
          style={{
            backgroundColor: "var(--card)",
            border: "1px solid var(--border)",
          }}
            ...
            <div className="flex gap-2">
              {filterConfigs.map((fc) => (
                <div key={fc.name} className="relative">
                  ...
                  >
                    {fc.value !== "All" ? fc.value : fc.name}{" "}
                    <ChevronDown
                      size={12}
                      style={{
                        transform:
                          openDropdown === fc.name ? "rotate(180deg)" : "none",
              ...
              {getPageNumbers().map((p, i) => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      p === currentPage ? "white" : "var(--muted-foreground)",
          ...
          <div className="space-y-2 mt-4">
            {hcDeptBreakdown.map((d, i) => (
              <div
                ...
                onClick={() => {
                  setDeptFilter(deptFilter === d.name ? "All" : d.name);
                  setCurrentPage(1);
                }}
                style={{
                  backgroundColor:
                    deptFilter === d.name ? "var(--secondary)" : "transparent",
                }}
              >
                <div className="flex items-center gap-2">
                  <div
                    ...
                    style={{
                      color:
                        deptFilter === d.name
                          ...
                          : "var(--muted-foreground)",
                      fontSize: "12px",
                      fontWeight: deptFilter === d.name ? 700 : 400,
                    }}
                  >
                    {d.name}
                  </span>
...
function PayrollSummary({ onBack }: { onBack: () => void }) {
  ...
  const handleExportPDF = () => {
    ...
    const rows = payrollEmployees
      .map(
        (e) =>
          `<tr><td style="padding:8px;border-bottom:1px solid #eee">${e.name}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.dept}</td><td style="padding:8px;border-bottom:1px solid #eee">₹${e.basic.toLocaleString()}</td><td style="padding:8px;border-bottom:1px solid #eee">₹${e.allowances.toLocaleString()}</td><td style="padding:8px;border-bottom:1px solid #eee">₹${e.deductions.toLocaleString()}</td><td style="padding:8px;border-bottom:1px solid #eee">₹${e.net.toLocaleString()}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.status}</td></tr>`,
      )
      .join("");
    w.document.write(
      `<html><head><title>Payroll Summary</title><style>body{font-family:system-ui,sans-serif;padding:40px;color:#1a1a1a}h1{color:#059669;margin-bottom:4px}p{color:#6b7280;margin-bottom:24px}table{width:100%;border-collapse:collapse}th{text-align:left;padding:10px 8px;background:#f0fdf4;color:#059669;font-size:11px;text-transform:uppercase;border-bottom:2px solid #059669}</style></head><body><h1>Payroll Summary</h1><p>April 2026</p><table><thead><tr><th>Employee</th><th>Department</th><th>Basic</th><th>Allowances</th><th>Deductions</th><th>Net Pay</th><th>Status</th></tr></thead><tbody>${rows}</tbody></table></body></html>`,
    );
    w.document.close();
    w.print();
  };
                ...
                <td className="px-4 py-3">
                  <span
                    ...
                    style={{
                      ...
                      color: emp.status === "Paid" ? "#059669" : "#F59E0B",
                    }}
                  >
                    {emp.status}
                  </span>
...
function AttendanceReport({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6">
      <ReportHeader
        title="Attendance Report — April 2026"
          ...
          <div className="grid grid-cols-10 gap-1.5">
            {days.map((d) => (
              <div
                ...
                style={{
                  aspectRatio: "1",
                  backgroundColor: `rgba(5, 150, 105, ${d.pct / 100})`,
                  minHeight: "32px",
                }}
              ...
              >
                <span
                  style={{
                    color: d.pct > 85 ? "white" : "var(--foreground)",
                    fontSize: "10px",
                    fontWeight: 600,
                  }}
                >
...
function PerformanceReview({ onBack }: { onBack: () => void }) {
  const handleExportCSV = () => {
    ...
    const rows = perfEmployees.map((e) => [
      e.name,
      e.dept,
      e.manager,
      e.score,
  ...
  const handleExportPDF = () => {
    const w = window.open("", "_blank");
    if (!w) return;
    const rows = perfEmployees
      .map(
        (e) =>
          `<tr><td style="padding:8px;border-bottom:1px solid #eee">${e.name}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.dept}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.manager}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.score}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.goals}%</td><td style="padding:8px;border-bottom:1px solid #eee">${e.status}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.date}</td></tr>`,
      )
      .join("");
    w.document.write(
      `<html><head><title>Performance Review</title><style>body{font-family:system-ui,sans-serif;padding:40px;color:#1a1a1a}h1{color:#059669;margin-bottom:4px}p{color:#6b7280;margin-bottom:24px}table{width:100%;border-collapse:collapse}th{text-align:left;padding:10px 8px;background:#f0fdf4;color:#059669;font-size:11px;text-transform:uppercase;border-bottom:2px solid #059669}</style></head><body><h1>Performance Review</h1><p>Q1 2026</p><table><thead><tr><th>Employee</th><th>Department</th><th>Manager</th><th>Score</th><th>Goals %</th><th>Status</th><th>Last Review</th></tr></thead><tbody>${rows}</tbody></table></body></html>`,
    );
    w.document.close();
    w.print();
  };
                  ...
                  <div className="flex items-center gap-1">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star
                        ...
                        size={11}
                        fill={
                          s <= Math.round(emp.score) ? "#F59E0B" : "transparent"
                        }
                        color={
                          s <= Math.round(emp.score) ? "#F59E0B" : "#D1D5DB"
                        }
                      />
                    ))}
                    <span
                ...
                <td className="px-4 py-3">
                  <span
                    ...
                    style={{
                      ...
                      color: emp.status === "Completed" ? "#059669" : "#F59E0B",
                    }}
                  >
                    {emp.status}
                  </span>
...
function RecruitmentPipeline({ onBack }: { onBack: () => void }) {
  const handleExportCSV = () => {
    ...
    const rows = recruitCandidates.map((e) => [
      e.name,
      e.role,
      e.source,
      e.stage,
  ...
  const handleExportPDF = () => {
    const w = window.open("", "_blank");
    if (!w) return;
    const rows = recruitCandidates
      .map(
        (e) =>
          `<tr><td style="padding:8px;border-bottom:1px solid #eee">${e.name}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.role}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.source}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.stage}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.applied}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.updated}</td></tr>`,
      )
      .join("");
    w.document.write(
      `<html><head><title>Recruitment Pipeline Report</title><style>body{font-family:system-ui,sans-serif;padding:40px;color:#1a1a1a}h1{color:#059669;margin-bottom:4px}p{color:#6b7280;margin-bottom:24px}table{width:100%;border-collapse:collapse}th{text-align:left;padding:10px 8px;background:#f0fdf4;color:#059669;font-size:11px;text-transform:uppercase;border-bottom:2px solid #059669}</style></head><body><h1>Recruitment Pipeline Report</h1><p>12 candidates · Apr 5, 2026</p><table><thead><tr><th>Candidate</th><th>Role Applied</th><th>Source</th><th>Stage</th><th>Applied</th><th>Updated</th></tr></thead><tbody>${rows}</tbody></table></body></html>`,
    );
    w.document.close();
    w.print();
  };
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6">
      <ReportHeader
        ...
        subtitle="12 candidates · Apr 5, 2026"
        onBack={onBack}
        onExportPDF={handleExportPDF}
        onExportCSV={handleExportCSV}
      />
...
function TurnoverAnalysis({ onBack }: { onBack: () => void }) {
  const handleExportCSV = () => {
    ...
    const rows = exitedEmployees.map((e) => [
      e.name,
      e.dept,
      e.role,
      e.tenure,
  ...
  const handleExportPDF = () => {
    const w = window.open("", "_blank");
    if (!w) return;
    const rows = exitedEmployees
      .map(
        (e) =>
          `<tr><td style="padding:8px;border-bottom:1px solid #eee">${e.name}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.dept}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.role}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.tenure}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.exit}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.reason}</td><td style="padding:8px;border-bottom:1px solid #eee">${e.interview ? "Yes" : "No"}</td></tr>`,
      )
      .join("");
    w.document.write(
      `<html><head><title>Turnover Analysis Report</title><style>body{font-family:system-ui,sans-serif;padding:40px;color:#1a1a1a}h1{color:#059669;margin-bottom:4px}p{color:#6b7280;margin-bottom:24px}table{width:100%;border-collapse:collapse}th{text-align:left;padding:10px 8px;background:#f0fdf4;color:#059669;font-size:11px;text-transform:uppercase;border-bottom:2px solid #059669}</style></head><body><h1>Turnover Analysis Report</h1><p>Mar 31, 2026</p><table><thead><tr><th>Employee</th><th>Department</th><th>Role</th><th>Tenure</th><th>Exit Date</th><th>Reason</th><th>Interviewed</th></tr></thead><tbody>${rows}</tbody></table></body></html>`,
    );
    w.document.close();
    w.print();
  };
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 space-y-6">
      <ReportHeader
        title="Turnover Analysis — Annual"
      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-2 space-y-5">
          ...
          <div
            className="rounded-2xl p-6 shadow-sm flex flex-col h-[320px]"
            style={{
              backgroundColor: "var(--card)",
              border: "1px solid var(--border)",
            }}
        ...
        <div className="space-y-5">
          {/* Exit Reasons */}
          <div
            className="rounded-2xl p-6 shadow-sm h-1/2 flex flex-col"
            style={{
              backgroundColor: "var(--card)",
              border: "1px solid var(--border)",
            }}
            ...
            <div className="space-y-3">
              {flightRisks.map((r, i) => (
                ...
                >
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-lg text-[9px] font-bold ${r.risk === "High" ? "bg-red-100 text-red-600" : "bg-amber-100 text-amber-600"}`}
                  >
                    {r.risk}
                  </span>
                </div>
            ...
            >
              {exitedEmployees.map((emp, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2 py-0.5 rounded text-[11px] font-bold bg-background border border-border">
                      {emp.tenure}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-muted-foreground">
...
export function Reports() {
    ...
    const rows = queryResults
      .map((row) => {
        const cells = selectedFields
          .map(
            (f) =>
              `<td style="padding: 12px; border-bottom: 1px solid #eee;">${row[f] || "---"}</td>`,
          )
          .join("");
        return `<tr>${cells}</tr>`;
      })
  ...
  const runCustomQuery = () => {
    ...
    setTimeout(() => {
      const filtered = mockEmployees.filter((emp) => {
        const matchDept =
          filterDept === "All Departments" || emp.Department === filterDept;
        const matchLoc =
  ...
  if (activeReport === "Recruitment Pipeline")
    return <RecruitmentPipeline onBack={() => setActiveReport(null)} />;
  if (activeReport === "Turnover Analysis")
    return <TurnoverAnalysis onBack={() => setActiveReport(null)} />;
  if (activeReport === "Shift Swap Report")
              ...
              {(["6M", "1Y", "2Y"] as const).map((t) => (
                <button
                  ...
                  style={{
                    ...
                    color:
                      timeRange === t ? "white" : "var(--muted-foreground)",
                  }}
                >
                  {t}
                </button>
                ...
                >
                  ...
                  >
                    <div style={{ display: "flex", gap: "8px" }}>
                      ...
                      <button
                        onClick={() => setShowPreviewModal(report.title)}
                        style={{
                          padding: "6px 12px",
                          borderRadius: "8px",
                          fontSize: "12px",
                    ...
                    <button
                      onClick={() => {
                        setScheduleReportType(report.title);
                        setShowScheduleModal(true);
                      }}
                      style={{
                        display: "flex",
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        onClick={handlePrintCustomQuery}
                        title="Print"
                        style={{
                          padding: "6px 10px",
                          borderRadius: "6px",
                      ...
                      <button
                        onClick={() => {
                          setScheduleReportType("Custom Query");
                          setShowScheduleModal(true);
                        }}
                        title="Schedule"
                        style={{
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                onClick={() => {
                  ...
                  triggerToast("Report schedule created successfully.");
                }}
                style={{
                  flex: 1,
                  padding: "12px",
      ...
      {showPreviewModal && (
        ...
        >
          ...
          >
                      ...
                      <td style={{ padding: "10px 8px" }}>
                        <span
                          style={{
                            ...
                            fontWeight: 700,
                            backgroundColor:
                              row.status === "Optimal" ? "#DCFCE7" : "#FEF3C7",
                            color:
                              row.status === "Optimal" ? "#15803D" : "#B45309",
                          }}
                        >
                          {row.status}
                        </span>
            ...
            <button
              onClick={() => {
                setActiveReport(showPreviewModal);
      ...
      {showAttritionModal && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => {
                setActiveReport("Turnover Analysis");
