...
interface NewHire {
  ...
  status: "on-track" | "delayed" | "at-risk" | "pre-joining" | "complete";
...
interface PhaseTask {
  ...
  owner: string;
  dueDate: string;
  status: "done" | "pending" | "overdue" | "in-progress";
  assignee: string;
}
  ...
  nh1: [
    {
      ...
      tasks: [
        ...
        {
          id: "t4",
          task: "Documents collected: Aadhar, PAN, Degree",
          owner: "HR",
          dueDate: "Apr 3",
          status: "done",
          assignee: "Priya Sharma",
        ...
        {
          id: "t5",
          task: "IT equipment ordered: Dell XPS + iPhone",
          owner: "IT",
          dueDate: "Apr 4",
          status: "done",
          assignee: "IT Team",
        ...
        {
          id: "t6",
          task: "Workspace/desk assigned: Zone B, Desk 14",
          owner: "Admin",
          dueDate: "Apr 4",
          status: "done",
          assignee: "Admin",
    ...
    },
    {
      ...
      tasks: [
        {
          id: "t7",
          task: "System credentials created",
          owner: "IT",
          dueDate: "Apr 7",
          status: "done",
          assignee: "IT Team",
        ...
        {
          id: "t9",
          task: "Laptop setup & configuration",
          owner: "IT",
          dueDate: "Apr 8",
          status: "in-progress",
          assignee: "IT Team",
    ...
    },
    {
      ...
      tasks: [
        ...
        {
          id: "t15",
          task: "System access setup — CRM, JIRA, GitHub",
          owner: "IT",
          dueDate: "Apr 9",
          status: "pending",
          assignee: "IT Team",
        ...
        {
          id: "t16",
          task: "NDA & policy acknowledgment signing",
          owner: "HR",
          dueDate: "Apr 10",
          status: "pending",
          assignee: "Priya Sharma",
        ...
        {
          id: "t17",
          task: "HR policy training (mandatory e-learning)",
          owner: "HR",
          dueDate: "Apr 11",
          status: "pending",
          assignee: "HR Team",
        ...
        {
          id: "t19",
          task: "Introduce to key stakeholders",
          owner: "Manager",
          dueDate: "Apr 11",
          status: "pending",
          assignee: "Suresh Iyer",
        ...
        {
          id: "t20",
          task: "Health insurance enrollment",
          owner: "Finance",
          dueDate: "Apr 12",
          status: "pending",
    ...
    },
    {
      ...
      tasks: [
        {
          id: "t22",
          task: "Role-specific technical training",
          owner: "Manager",
          dueDate: "Apr 22",
          status: "pending",
          assignee: "Suresh Iyer",
        ...
        {
          id: "t23",
          task: "Company culture & values session",
          owner: "HR",
          dueDate: "Apr 15",
          status: "pending",
          assignee: "HR Team",
        ...
        {
          id: "t24",
          task: "Complete all mandatory e-learning modules",
          owner: "HR",
          dueDate: "Apr 30",
          status: "pending",
          assignee: "Priya Sharma",
        ...
        {
          id: "t25",
          task: "Set FY goals with manager",
          owner: "Manager",
          dueDate: "Apr 20",
          status: "pending",
          assignee: "Suresh Iyer",
        ...
        {
          id: "t26",
          task: "First performance check-in",
          owner: "Manager",
          dueDate: "May 1",
          status: "pending",
          assignee: "Suresh Iyer",
        ...
        {
          id: "t27",
          task: "Buddy/mentor program enrollment",
          owner: "HR",
          dueDate: "Apr 15",
          status: "pending",
          assignee: "HR Team",
        ...
        {
          id: "t28",
          task: "30-day feedback form completion",
          owner: "HR",
          dueDate: "May 8",
          status: "pending",
          assignee: "Priya Sharma",
...
export function Onboarding() {
          ...
          prev.map((nh) =>
            nh.id === selectedId
              ? {
                  ...nh,
                  progress,
                  status: progress === 100 ? "complete" : nh.status,
                }
              : nh,
          ),
        );
  ...
  const selected =
    newHires.find((n) => n.id === selectedId) || newHires[0] || NEW_HIRES[0];
  const phases =
    safeGet<OnboardingPhase[]>(phasesData, selected.id) || phasesData.nh1;
  ...
  const handleLaunchOnboarding = () => {
    ...
    setPhasesData(
      (prev) =>
        safeSet(prev, newId, newPhases) as Record<string, OnboardingPhase[]>,
    );
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          ...
          >
            ...
            <h3
              className={`text-lg font-black tracking-tighter ${card.valColor}`}
            >
              {card.value}
            </h3>
            ...
            <div className="flex-1 bg-card border border-border rounded-2xl shadow-sm overflow-y-auto h-[calc(100vh-340px)]">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 mt-1 text-[12px] font-semibold text-muted-foreground">
                    <span className="flex items-center gap-1">
                      ...
                      {formatDate(selected.joiningDate)}
                    </span>
                    <span className="flex items-center gap-1">
              ...
              <div className="px-6 py-3 border-b border-border flex items-center gap-4">
                ...
                <span
                  ...
                  style={{ color: selected.progressColor }}
                >
                            ...
                            <div className="flex items-center gap-2 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                              ...
                              {task.owner === "HR" &&
                                task.status === "in-progress" && (
                                  <button
                                    onClick={() =>
                                      handleMarkDone(phase.id, task.id)
                                    }
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 h-[6px] w-24 bg-muted/50 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(uploadedDocs / documents.length) * 100}%`,
                        }}
                      />
                    </div>
                    <span className="text-[11px] font-bold text-muted-foreground">
            ...
            >
              ...
              <div className="px-8 py-3 border-b border-border flex items-center gap-2">
                {[1, 2, 3].map((s) => (
                  <div
                    key={s}
                    className={`w-2.5 h-2.5 rounded-full transition-all ${initiateStep >= s ? "bg-[#00B87C]" : "bg-border"}`}
                  />
                ))}
              ...
              {initiateStep === 1 && (
                <div className="px-8 py-6 space-y-5 overflow-y-auto max-h-[50vh]">
                    ...
                    <div className="mt-2 space-y-1 max-h-32 overflow-y-auto bg-muted/20 rounded-xl p-1">
                      {employees
                        .filter((emp) =>
                          emp.name
                            .toLowerCase()
                            .includes(formEmployee.toLowerCase()),
                        )
                        .slice(0, 5)
                        .map((emp) => (
                          <button
                          ...
                          >
                            <div className="w-7 h-7 rounded-full bg-[#00B87C]/10 flex items-center justify-center text-[#00B87C] text-[9px] font-black">
                              {initials(emp.name)}
                            </div>
                            <div>
                  ...
                  <div>
                    <label className="text-[9px] font-semibold text-muted-foreground uppercase tracking-wider mb-2 block">
                      Employment Type
                    </label>
                    <div className="flex gap-2">
                      {["Full-time", "Part-time", "Contract", "Intern"].map(
                        (t) => (
                          <button
                            key={t}
                            onClick={() => setFormEmpType(t)}
                            className={`px-4 py-2 rounded-xl border text-[11px] font-black uppercase tracking-wider transition-all ${formEmpType === t ? "bg-[#00B87C] text-white border-[#00B87C]" : "border-border hover:bg-muted text-muted-foreground"}`}
                          >
                            {t}
                          </button>
                        ),
                  ...
                  <div className="space-y-3 max-h-72 overflow-y-auto">
                    {TEMPLATES.map((tpl) => (
                      <div
                        ...
                        className={`p-4 rounded-2xl border-2 cursor-pointer transition-all ${selectedTemplate === tpl.id ? "border-[#00B87C]" : "border-border hover:border-[#00B87C]/40"}`}
                      >
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-[11px] text-muted-foreground">
                              {tpl.phases} phases, {tpl.tasks} tasks
                            </p>
                          </div>
                          <div className="flex items-center gap-2">
                            {deptBadge(tpl.dept, tpl.deptColor)}
              ...
              <div className="px-8 py-4 border-t border-border flex items-center justify-between">
                <button
                  onClick={() => setShowInitiateModal(false)}
                  className="px-5 py-2.5 rounded-xl border border-border text-[11px] font-black text-foreground uppercase tracking-widest hover:bg-muted transition-all"
                >
                  Cancel
                </button>
                <div className="flex items-center gap-3">
                  {initiateStep > 1 && (
                    <button
                      onClick={() => setInitiateStep((s) => s - 1)}
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-border text-[11px] font-black text-foreground uppercase tracking-widest hover:bg-muted transition-all"
                    >
                  ...
                  {initiateStep < 3 ? (
                    <button
                      onClick={() => setInitiateStep((s) => s + 1)}
                      className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00B87C] text-white text-[11px] font-semibold uppercase tracking-wider hover:opacity-90 transition-all shadow-md"
                    >
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 rounded-xl bg-[#00B87C] text-white text-[11px] font-semibold uppercase tracking-wider hover:opacity-90 transition-all shadow-lg shadow-[#00B87C]/20"
                    >
                      Launch Onboarding
                    </button>
                  )}
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        {deptBadge(tpl.dept, tpl.deptColor)}
                        <span
                          className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${tpl.avgDays !== "—" ? "bg-[#00B87C]/10 text-[#00B87C] border border-[#00B87C]/20" : "bg-muted/50 text-muted-foreground border border-border"}`}
                        >
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-muted-foreground">
                    This will notify the admin about the overdue task.
                  </p>
                </div>
              </div>
              <textarea
                className="w-full px-4 py-3 rounded-2xl border border-border bg-background text-[12px] font-bold outline-none focus:ring-2 focus:ring-[#EF4444]/20 transition-all resize-none"
                rows={3}
              ...
              <div className="flex items-center justify-end gap-3 mt-4">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-[#EF4444] text-white text-[11px] font-semibold uppercase tracking-wider hover:opacity-90 transition-all shadow-md"
                >
                  Confirm Escalation
                </button>
              </div>
                ...
                <button
                  onClick={() => {
                    showToast(
                      "Reminder Sent",
                      "success",
                      `Reminder sent to ${selected.name}'s pending task owners.`,
                    );
        ...
        <div className="fixed bottom-24 right-8 w-80 bg-card border border-border rounded-2xl shadow-2xl p-4 z-40">
          ...
          <div className="flex items-center gap-2 mb-3">
            <select
              ...
              value={inlineTaskOwner}
              onChange={(e) => setInlineTaskOwner(e.target.value)}
            >
              <option>HR</option>
              <option>IT</option>
              <option>Manager</option>
