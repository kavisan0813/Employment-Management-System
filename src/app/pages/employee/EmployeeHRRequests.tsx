        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[13px] font-bold text-muted-foreground mt-1.5">
              Track and manage your administrative requests
            </p>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-secondary/30">
                <th className="px-6 py-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest">
                  Request Details
                </th>
                <th className="px-6 py-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest">
                  Type
                </th>
                <th className="px-6 py-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest text-center">
                  Priority
                </th>
                <th className="px-6 py-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest">
                  Submitted Date
                ...
                <th className="px-6 py-5 text-[11px] font-black text-muted-foreground uppercase tracking-widest text-right">
                  Action
                </th>
              </tr>
            </thead>
    ...
    <div className="fixed inset-0 z-[3000] flex items-center justify-end">
      ...
      >
        ...
        <div className="p-6 border-t border-border bg-white dark:bg-card flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 py-3.5 rounded-xl border border-border text-[13px] font-black text-muted-foreground hover:bg-secondary transition-all"
          >
            Close
          </button>
