...
export function SettingsProvider({ children, defaultTab = "company" }: { children: ReactNode; defaultTab?: string }) {
  ...
  const contextValue = {
    ...
    handleRoleSubmit, confirmEditRoleSubmit,
    toggleCell,
    ...
    // Departments
    deptsList, setDeptsList,
    selectedDept, setSelectedDept,
    deptForm, setDeptForm,
    deptSearchQuery, setDeptSearchQuery,
    deptStatusFilter, setDeptStatusFilter,
    deptSortBy, setDeptSortBy,
    allowSubDepts, setAllowSubDepts,
    requireCostCenter, setRequireCostCenter,
    budgetTracking, setBudgetTracking,
    budgetThreshold, setBudgetThreshold,

    // Locations
    locationsList, setLocationsList,
    selectedLoc, setSelectedLoc,
    locForm, setLocForm,
    locSearchQuery, setLocSearchQuery,
    locStatusFilter, setLocStatusFilter,
    locTypeFilter, setLocTypeFilter,
    locSortBy, setLocSortBy,
    gpsAttendance, setGpsAttendance,
    allowRemoteWork, setAllowRemoteWork,
    requireGeofence, setRequireGeofence,
    regionHolidays, setRegionHolidays,
    geofenceRadius, setGeofenceRadius,
    defaultLocCountry, setDefaultLocCountry,

    // Work Schedules
    schedulesList, setSchedulesList,
    selectedSchedule, setSelectedSchedule,
    scheduleForm, setScheduleForm,
    wsGracePeriod, setWsGracePeriod,
    wsWeeklyHours, setWsWeeklyHours,
    wsOtThreshold, setWsOtThreshold,
    wsMinRest, setWsMinRest,
    wsHalfDay, setWsHalfDay,
    wsAbsentThreshold, setWsAbsentThreshold,
    wsAutoOt, setWsAutoOt,
    wsRequireOtApproval, setWsRequireOtApproval,
    wsOtAlert, setWsOtAlert,
    wsCompOff, setWsCompOff,
    schedSearchQuery, setSchedSearchQuery,
    schedStatusFilter, setSchedStatusFilter,
    schedTypeFilter, setSchedTypeFilter,
    schedLocFilter, setSchedLocFilter,

    // Holidays
    holidaysList, setHolidaysList,
    selectedHoliday, setSelectedHoliday,
    holidayForm, setHolidayForm,
    holAutoMark, setHolAutoMark,
    holOptional, setHolOptional,
    holRegionSpecific, setHolRegionSpecific,
    holSearchQuery, setHolSearchQuery,
    holYearFilter, setHolYearFilter,
    holMonthFilter, setHolMonthFilter,
    holTypeFilter, setHolTypeFilter,
    holLocFilter, setHolLocFilter,
    holStatusFilter, setHolStatusFilter,
    holidayViewMode, setHolidayViewMode,

    // Leave Policy
    leaveTypesList, setLeaveTypesList,
    selectedLeaveType, setSelectedLeaveType,
    leaveTypeForm, setLeaveTypeForm,
    lpApprovalLevels, setLpApprovalLevels,
    lpPolicyVersion, setLpPolicyVersion,
    lpLastUpdatedBy, setLpLastUpdatedBy,
    lpLastUpdatedTime, setLpLastUpdatedTime,

    // Payroll
    payrollCycle, setPayrollCycle,
    payrollCutoff, setPayrollCutoff,
    payrollPayout, setPayrollPayout,
    prGrossStructure, prComponentsCount, prNextRun,
    prLastUpdatedBy, setPrLastUpdatedBy,
    prLastUpdatedTime, setPrLastUpdatedTime,
    prLopEnabled, setPrLopEnabled,
    prHalfDayCalc, setPrHalfDayCalc,
    prOtPay, setPrOtPay,
    prLateDeduct, setPrLateDeduct,
    prPayslipLogo, setPrPayslipLogo,
    prPayslipTemplate, setPrPayslipTemplate,
    prAutoEmail, setPrAutoEmail,
    prPfRate, setPrPfRate,
    prEsiRate, setPrEsiRate,
    prTaxMode, setPrTaxMode,
    salaryComponentsList,
    handlePayrollSubmit, handleResetPayroll,

    // Performance
    perfReviewFreq, setPerfReviewFreq,
    perfReviewMonth, setPerfReviewMonth,
    perfSelfReviewWin, setPerfSelfReviewWin,
    perfMgrReviewWin, setPerfMgrReviewWin,
    perfCalibrationDeadline, setPerfCalibrationDeadline,
    perfHrFinalizationDeadline, setPerfHrFinalizationDeadline,
    perfRatingScale, setPerfRatingScale,
    perfPeerFeedback, setPerfPeerFeedback,
    perfAnonPeerFeedback, setPerfAnonPeerFeedback,
    perfSubFeedback, setPerfSubFeedback,
    perfClientFeedback, setPerfClientFeedback,
    perfMinPeers, setPerfMinPeers,
    perfGoalSetting, setPerfGoalSetting,
    perfLinkGoals, setPerfLinkGoals,
    perfRequireGoalApp, setPerfRequireGoalApp,
    perfQuarterlyCheckin, setPerfQuarterlyCheckin,
    perfOkrSupport, setPerfOkrSupport,
    perfMaxGoals, setPerfMaxGoals,
    perfGoalDeadline, setPerfGoalDeadline,

    // Security
    secEnforceMfa, setSecEnforceMfa,
    secGoogleSso, setSecGoogleSso,
    secMicrosoftSso, setSecMicrosoftSso,
    secSsoOnly, setSecSsoOnly,
    secPwMinLen, setSecPwMinLen,
    secPwUpper, setSecPwUpper,
    secPwNumbers, setSecPwNumbers,
    secPwPreventReuse, setSecPwPreventReuse,
    secPwForceChange, setSecPwForceChange,
    secPwExpiry, setSecPwExpiry,
    secMaxFailedAttempts, setSecMaxFailedAttempts,
    secLockoutDuration, setSecLockoutDuration,
    secLockoutResetMethod, setSecLockoutResetMethod,
    secIdleTimeout, setSecIdleTimeout,
    secIpWhitelisting, setSecIpWhitelisting,
    secLogLogins, setSecLogLogins,
    secAlertSuspicious, setSecAlertSuspicious,
    secAllowedIpRanges, setSecAllowedIpRanges,

    // API & Integrations
    apiRest, setApiRest,
    apiIpWhite, setApiIpWhite,
    apiWebhook, setApiWebhook,
    apiLog, setApiLog,
    apiRateLimit, setApiRateLimit,
    apiTokenExp, setApiTokenExp,
    apiConcurrent, setApiConcurrent,
    apiVersion, setApiVersion,
    apiAllowedIp, setApiAllowedIp,
    webhookRetry, setWebhookRetry,
    webhookHmac, setWebhookHmac,
    ...
    emailAddLogo, setEmailAddLogo,
    emailAddUnsub, setEmailAddUnsub,
    emailBccHr, setEmailBccHr,
    notifyLeaveEmail, setNotifyLeaveEmail,
    notifyLeavePush, setNotifyLeavePush,
    notifyLeaveSms, setNotifyLeaveSms,
    notifyPayEmail, setNotifyPayEmail,
    notifyPayPush, setNotifyPayPush,
    notifyPaySms, setNotifyPaySms,
    notifyAttEmail, setNotifyAttEmail,
    notifyAttPush, setNotifyAttPush,
    notifyAttSms, setNotifyAttSms,
    notifyPerfEmail, setNotifyPerfEmail,
    notifyPerfPush, setNotifyPerfPush,
    notifyPerfSms, setNotifyPerfSms,
    notifyEmpEmail, setNotifyEmpEmail,
    notifyEmpPush, setNotifyEmpPush,
    notifyEmpSms, setNotifyEmpSms,
    notifyShiftEmail, setNotifyShiftEmail,
    notifyShiftPush, setNotifyShiftPush,
    notifyShiftSms, setNotifyShiftSms,
    notifyDocEmail, setNotifyDocEmail,
    notifyDocPush, setNotifyDocPush,
    notifyDocSms, setNotifyDocSms,
    notifySysEmail, setNotifySysEmail,
    notifySysPush, setNotifySysPush,
    notifySysSms, setNotifySysSms,
    notifyDigestFreq, setNotifyDigestFreq,
    notifyLeaveDays, setNotifyLeaveDays,
    notifyPerfDays, setNotifyPerfDays,
    notifyPayTime, setNotifyPayTime,
    notifyWeekend, setNotifyWeekend,
    notifyQuiet, setNotifyQuiet,

    // SMS
    smsProvider, setSmsProvider,
    smsSenderId, setSmsSenderId,
    smsApiKey, setSmsApiKey,
    smsAuthToken, setSmsAuthToken,
    smsCountryCode, setSmsCountryCode,
    smsDltId, setSmsDltId,
    smsTriggerPay, setSmsTriggerPay,
    smsTriggerLeave, setSmsTriggerLeave,
    smsTriggerOtp, setSmsTriggerOtp,
    smsTriggerShift, setSmsTriggerShift,
    smsTriggerAtt, setSmsTriggerAtt,
    smsTriggerOnboard, setSmsTriggerOnboard,
    smsTriggerPerf, setSmsTriggerPerf,

    // Appearance & Preferences
    themeMode, setThemeMode,
    appLanguage, setAppLanguage,
    appTimezone, setAppTimezone,
    appDateFormat, setAppDateFormat,
    extraConfig, updateExtraConfig,

    // Onboarding
    activeOnboardingPhaseTab, setActiveOnboardingPhaseTab,
    ...
    reactivateConfirm, setReactivateConfirm,
    getStatusStyles, getRoleStyles,
