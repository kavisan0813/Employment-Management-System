...
export function AuthSuccess() {
  ...
  const getRoleSpecificPortal = () => {
    switch (role) {
      ...
      case "HR Admin":
        return "HR Dashboard ready";
      case "Manager":
        return "Team dashboard ready";
      case "Employee":
        return "Employee portal ready";
      case "Payroll Admin":
        return "Payroll dashboard ready";
      case "Recruiter":
        return "Hiring dashboard ready";
      default:
      ...
      >
        ...
        >
          ...
          <div className="mt-8 flex items-center justify-center gap-6">
            ...
            <button className="text-xs font-bold text-muted-foreground hover:text-emerald-600 transition-colors flex items-center gap-1.5">
              <HelpCircle size={14} />
              Need Help?
            </button>
          </div>
