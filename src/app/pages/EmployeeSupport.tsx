    ...
    <div className="flex flex-col gap-6 animate-in fade-in duration-700 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-[13px] font-bold text-muted-foreground mt-3">In progress</p>
        </div>
        ...
        >
          ...
          <p className="text-[13px] font-bold text-muted-foreground mt-3">this month</p>
        </div>
        ...
        <div className="bg-card p-6 rounded-[24px] border border-border shadow-sm group hover:shadow-md transition-all overflow-hidden relative">
          ...
          <p className="text-[32px] font-black" style={{ color: "#111827" }}>1.2 days</p>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-secondary/30">
              <th className="px-6 py-4 text-[10px] font-black text-muted-foreground uppercase tracking-widest whitespace-nowrap">TICKET ID</th>
          ...
          <tbody className="divide-y divide-border">
            {TICKETS.map((row, i) => (
              <tr key={i} className="hover:bg-secondary/50 transition-colors group cursor-pointer" onClick={() => onViewTicket(row)}>
                ...
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border" style={{ backgroundColor: row.catBg, color: row.catColor, borderColor: row.catBg }}>
                    {row.category}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border" style={{ backgroundColor: row.priorityBg, color: row.priorityColor, borderColor: row.priorityBg }}>
                    {row.priority}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border" style={{ backgroundColor: row.statusBg, color: row.statusColor, borderColor: row.statusBg }}>
                    {row.status}
                  </span>
                </td>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {FAQ_CATEGORIES.map((category, i) => (
          <div key={i} className="bg-card p-6 rounded-[24px] border border-border shadow-sm group hover:border-primary transition-all cursor-pointer hover:shadow-md flex flex-col items-start">
            ...
            <div className="flex items-center gap-1 text-primary text-[12px] font-black mt-auto">
              Browse <ChevronRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </div>
          </div>
        ))}
      </div>
