...
function AddCourseModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-border p-6 animate-in zoom-in-95"
      ...
      >
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={onClose}
            className="flex-1 py-2 text-xs font-black text-slate-600 dark:text-slate-300 bg-neutral-100 dark:bg-zinc-800 rounded-xl hover:bg-neutral-200"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="flex-1 py-2 text-xs font-black text-white bg-[#00B87C] hover:bg-[#00a36d] rounded-xl"
          >
            Save Course
          </button>
        </div>
...
function CoursePlayerModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-border p-6 animate-in zoom-in-95 flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between border-b border-border pb-3 mb-4">
          <div>
          ...
          <button
            onClick={onClose}
            className="p-1 text-muted-foreground hover:bg-neutral-100 dark:hover:bg-zinc-800 rounded-lg flex-shrink-0"
          >
            <X size={18} />
          </button>
        </div>
    ...
    <div className="w-full px-4 md:px-8 py-6 pb-10">
      ...
      <div className="bg-white dark:bg-zinc-900/60 border border-border rounded-xl px-4 py-2.5 text-[11px] text-slate-600 dark:text-slate-400 font-bold flex items-center gap-4 flex-wrap mb-6 shadow-sm">
        ...
        <span className="flex items-center gap-1.5 text-teal-600">
          <span className="w-2 h-2 rounded-full bg-teal-500 inline-block" />8
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
        {[
          ...
          >
            <div
              className={`w-9 h-9 rounded-xl flex items-center justify-center ${kpi.bg} dark:bg-zinc-800/50 ${kpi.color}`}
            >
              <kpi.icon size={18} />
            </div>
            <div>
              ...
              <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-none">
                {enrolledCourses.map((course) => (
                  ...
                  >
                    {/* Gradient Banner */}
                    <div
                      className={`h-[120px] bg-gradient-to-br ${getGradient(course.type)} p-3 relative flex flex-col justify-between`}
                    >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {initialCertifications.map((cert, idx) => (
                  <div
                    key={idx}
                    className="bg-white dark:bg-zinc-900 p-4 rounded-2xl border border-border shadow-sm flex items-center justify-between gap-4"
                  >
      ...
      {activeTab === "Mandatory" && (
        <div className="max-w-3xl mx-auto space-y-4">
          {[
            ...
            <div
              key={idx}
              className={`bg-white dark:bg-zinc-900 p-4 rounded-xl border border-border shadow-sm border-l-4 ${
          ...
          <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-border shadow-sm">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-300 bg-neutral-50 dark:bg-zinc-800/30 border border-border p-3 rounded-xl"
                >
