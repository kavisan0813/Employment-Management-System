      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm font-medium">
            Track employee claims, approvals, and reimbursements effortlessly.
          </p>
        </div>
          ...
          >
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`flex items-center gap-1 text-xs font-bold ${stat.isUp ? "text-emerald-500" : "text-rose-500"}`}
                >
                  {stat.isUp ? (
        ...
        <div className="p-8 border-b border-border flex items-center justify-between">
          <div>
            ...
            <p className="text-xs font-bold text-muted-foreground mt-1">
              Manage reimbursements, receipts, and payouts effortlessly.
            </p>
          </div>
                  ...
                  >
                    ...
                    <ActionItem
                      ...
                      onClick={() => {
                        ...
                        toast.success("Table view reset");
                        setShowSettingsMenu(false);
                      }}
                    />
                    <div className="border-t border-border my-1" />
                    <ActionItem
                      ...
                      onClick={() => {
                        ...
                        setTimeout(
                          () => navigate("/settings?tab=audit_logs"),
                          500,
                        );
                        setShowSettingsMenu(false);
                      }}
                ...
                {showShareMenu && (
                  ...
                  >
                    ...
                    <ActionItem
                      ...
                      onClick={() => {
                        setShowManagerShare(true);
                        setShowShareMenu(false);
                      }}
                    />
                    <ActionItem
                      icon={<ShieldCheck size={14} />}
                      label="Share with Finance"
                      onClick={() => {
                        setShowFinanceShare(true);
                        setShowShareMenu(false);
                      }}
                    />
                    <div className="border-t border-border my-1" />
            ...
            <thead>
              <tr className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/70 bg-muted/30">
                ...
                {visibleColumns.approval && (
                  <th className="px-4 py-5">Approval</th>
                )}
                {visibleColumns.reimbursement && (
                  <th className="px-4 py-5">Reimbursement</th>
                )}
            ...
            <tbody className="divide-y divide-border">
              {filteredClaims.map((claim, index) => (
                ...
                >
                  ...
                  {visibleColumns.category && (
                    <td className="px-4 py-5">
                      <span className="flex items-center gap-1.5 text-xs font-bold text-foreground">
                        <span className="w-6 h-6 rounded-lg bg-muted flex items-center justify-center text-sm">
                          {claim.catIcon}
                        </span>
                        {claim.category}
                      </span>
                  ...
                  {visibleColumns.date && (
                    <td className="px-4 py-5 text-xs font-bold text-muted-foreground">
                      {claim.date}
                    </td>
                  )}
                  ...
                  {visibleColumns.receipt && (
                    <td className="px-4 py-5">
                      <button
                        className="flex items-center gap-1 text-[11px] font-black text-emerald-500 hover:underline uppercase tracking-wider"
                        onClick={(e) => {
                          e.stopPropagation();
                          setReceiptToView(claim);
                        }}
                      >
                  ...
                  {visibleColumns.reimbursement && (
                    <td className="px-4 py-5">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${claim.reimbursementStatus === "Paid" ? "bg-emerald-500" : "bg-slate-300"}`}
                        />
                  ...
                  <td className="px-8 py-5 text-right">
                    ...
                    >
                      <button
                        onClick={() => setViewClaim(claim)}
                        className="p-2 rounded-xl border border-border text-muted-foreground hover:bg-muted/50 hover:text-emerald-500 transition-all"
                        title="Quick View"
                      >
                        <Eye size={16} />
                      </button>
                      <div className="relative">
                        <button
                          onClick={() =>
                            setActiveActionId(
                              claim.id === activeActionId ? null : claim.id,
                            )
                          }
                          ...
                          {activeActionId === claim.id && (
                            ...
                            >
                              ...
                              <ActionItem
                                ...
                                onClick={() => {
                                  toast.success(
                                    `Downloading report for ${claim.id}...`,
                                  );
                                  setActiveActionId(null);
                                }}
                              />
            ...
            >
              ...
              <div className="space-y-6">
                <WorkflowBlock
                  title="Submission"
                  status="Automated"
                  desc="Employee submits receipt via Self-Service portal."
                  completed
                />
                <WorkflowBlock
                  title="Department Review"
                  status="Manager Action"
                  desc="Direct reporting manager validates and approves spend."
                  active
                />
                <WorkflowBlock
                  title="Finance Audit"
                  status="Accounting"
                  desc="Finance team checks policy compliance and tax deductions."
                />
                <WorkflowBlock
                  title="Payout"
                  status="Final Step"
                  desc="Funds are transferred via automated payroll batch."
                />
              </div>

              <button
                onClick={() => setShowWorkflowModal(false)}
                className="mt-8 w-full py-3 bg-emerald-500 text-white rounded-2xl font-black text-sm shadow-xl shadow-emerald-500/20 hover:bg-emerald-600 transition-all"
              >
                Close Pipeline View
              </button>
            </motion.div>
            ...
            >
              ...
              <div className="p-8 grid grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto">
                <div className="space-y-1.5">
                  ...
                  <select
                    defaultValue={editingClaim?.category}
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 outline-none font-bold"
                  >
                    {categories.map((c) => (
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    type="number"
                    defaultValue={editingClaim?.amount}
                    placeholder="0.00"
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 outline-none font-bold"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <select
                    defaultValue={editingClaim?.paymentMode}
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 outline-none font-bold"
                  >
                ...
                <div className="col-span-2 space-y-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="Provide details for faster approval..."
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 outline-none font-medium"
                  />
                </div>
                <div className="col-span-2 border-2 border-dashed border-emerald-500/20 bg-emerald-500/[0.02] rounded-3xl p-8 text-center group hover:border-emerald-500/40 transition-all cursor-pointer">
                  <Upload
                    size={32}
                    className="mx-auto mb-2 text-emerald-500 opacity-40"
                  />
                  <p className="text-sm font-black text-foreground">
              ...
              <div className="p-8 border-t border-border bg-muted/20 flex gap-4">
                <button
                  ...
                  className="flex-1 py-3 text-sm font-black text-muted-foreground hover:bg-muted rounded-2xl transition-all"
                >
                  Cancel
                </button>
                <button
          ...
          <div className="fixed inset-0 z-[4000] flex justify-end">
            ...
            >
              <div className="p-8 border-b border-border flex items-center justify-between bg-emerald-500/[0.02]">
                ...
                <button
                  onClick={() => setViewClaim(null)}
                  className="p-2 rounded-xl hover:bg-muted text-slate-400"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-8 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <DetailItem
                    label="Category"
                    val={viewClaim.category}
                    icon={viewClaim.catIcon}
                  />
                  <DetailItem label="Claim Date" val={viewClaim.date} />
                  <DetailItem
                    label="Payment Mode"
                    val={viewClaim.paymentMode}
                  />
                  <DetailItem
                    label="Status"
                    val={viewClaim.approvalStatus}
                    isStatus
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group rounded-3xl overflow-hidden border border-border shadow-lg h-48 bg-muted">
                    <img
                      src="https://images.unsplash.com/photo-1554224155-1696413565d3?q=80&w=600"
                      alt="Receipt"
                    ...
                    <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                      <button className="px-4 py-2 bg-white text-slate-900 text-[11px] font-black rounded-xl shadow-xl flex items-center gap-2">
                        <Download size={14} /> Full Receipt
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-8 border-t border-border bg-muted/20 flex gap-3">
                ...
                <button
                  className="flex-1 py-3 text-sm font-black text-rose-600 bg-white dark:bg-zinc-900 border border-border rounded-2xl hover:bg-rose-50"
                  onClick={() => {
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    rows={2}
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-medium outline-none"
              ...
              <div className="flex gap-3 mt-8">
                <button
                  onClick={() => setShowManagerShare(false)}
                  className="flex-1 py-3 text-sm font-black text-muted-foreground bg-muted hover:bg-slate-200 rounded-2xl transition-all"
                >
                  Cancel
                </button>
                <button
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-bold outline-none">
                      <option>Engineering (ENG-01)</option>
                    </select>
                  </div>
                </div>
                <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    rows={2}
                    className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-medium outline-none"
                    placeholder="Internal finance instructions..."
                  />
                </div>
              </div>
              <div className="flex gap-3 mt-8">
        ...
        {showApproveModal && (
          <div className="fixed inset-0 z-[8000] flex items-center justify-center p-4">
            ...
            >
              <button
                onClick={() => setShowApproveModal(false)}
                className="absolute top-6 right-6 p-2 rounded-xl hover:bg-muted text-muted-foreground transition-all"
              >
                <X size={20} />
              </button>
              ...
              <p className="text-sm font-medium text-muted-foreground mt-2 mb-8 px-4">
                You are about to approve the expense of{" "}
                <span className="text-foreground font-black">
                  {formatCurrency(selectedClaim?.amount || 0)}
                </span>{" "}
                for {selectedClaim?.employee.name}.
              </p>
              <div className="flex gap-3">
                <button
                  onClick={() => setShowApproveModal(false)}
                  className="flex-1 py-3 text-sm font-black text-muted-foreground bg-muted rounded-2xl transition-all"
                >
                  Cancel
                </button>
                <button
            ...
            >
              ...
              <div className="space-y-1.5 mb-8">
                ...
                <textarea
                  rows={3}
                  required
                  className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-medium outline-none focus:border-rose-500 transition-colors"
                  placeholder="e.g. Missing valid tax invoice, category mismatch..."
                />
              </div>
              <div className="flex gap-3">
                <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-bold outline-none"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <WorkflowBlock
                      title="Submitted"
                      status="Completed"
                      desc={`Expense claim initiated on ${viewClaim.date}`}
                      completed
                    />
                    <WorkflowBlock
                      title="Shared with Manager"
                      status="Action Done"
                      desc="Sent to Robert Fox for initial validation."
                      completed
                    />
                    <WorkflowBlock
                      title="Manager Approved"
                      status="In Progress"
                      desc="Pending final manager digital signature."
                      active
                    />
                    <WorkflowBlock
                      title="Sent to Finance"
                      status="Waiting"
                      desc="Awaiting tax compliance audit."
                    />
                    <WorkflowBlock
                      title="Paid"
                      status="Final Step"
                      desc="Fund transfer via automated payroll batch."
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="bg-muted/30 p-4 rounded-2xl space-y-2">
                    <p className="text-xs font-bold text-foreground leading-relaxed">
                      "The Uber receipt matches the client meeting schedule in
                      Outlook."
                    </p>
                    <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">
                      — System Audit • 10:20 AM
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative group rounded-3xl overflow-hidden border border-border shadow-lg h-48 bg-muted">
                    ...
                    <div className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          setReceiptToView(viewClaim);
                        }}
                        className="px-4 py-2 bg-white text-slate-900 text-[11px] font-black rounded-xl shadow-xl flex items-center gap-2"
                      >
          ...
          <div className="fixed inset-0 z-[7000] flex items-center justify-center p-4">
            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  onClick={() => setShowColumnModal(false)}
                  className="p-3 rounded-2xl bg-muted text-foreground hover:bg-slate-200 dark:hover:bg-zinc-800 transition-all"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <button
                onClick={() => setShowColumnModal(false)}
                className="mt-8 w-full py-4 bg-emerald-500 text-white rounded-2xl font-black text-sm shadow-xl shadow-emerald-500/20 active:scale-95 transition-all"
              >
                Save Preferences
              </button>
            </motion.div>
          ...
          <div className="fixed inset-0 z-[6000] flex items-center justify-center p-4">
            ...
            >
              <div className="px-10 py-6 border-b border-border flex items-center justify-between bg-emerald-500/[0.02]">
                ...
                <div className="flex items-center gap-3">
                  <button
                    className="p-3 rounded-2xl border border-border text-muted-foreground hover:bg-muted transition-all"
          ...
          {[1, 2].map((_, i) => (
            ...
            >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  className="w-full px-4 py-3 text-sm rounded-2xl border border-border bg-muted/30 font-medium outline-none h-20"
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 text-[11px] font-black text-rose-600 bg-rose-500/5 rounded-xl"
                >
                  Reject
                </button>
                <button
                  onClick={() => toast.info("Returned to employee")}
                  className="flex-1 py-2.5 text-[11px] font-black text-muted-foreground bg-muted rounded-xl"
                >
                  Return
                </button>
              </div>
      ...
      >
        <div className="space-y-4">
          {[
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-slate-900 text-white flex items-center justify-center font-black text-xs shadow-xl">
                  {item.id}
                </div>
                <div>
                  <p className="text-sm font-black text-foreground">
          ...
          {[
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => {
                    setShowRejectedResubmit(false);
                    setShowAddModal(true);
                    setIsEditing(true);
                  }}
                  className="flex-1 py-3 text-[11px] font-black text-muted-foreground bg-muted rounded-xl"
                >
                  Edit Claim
                </button>
              </div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mt-1">
                Operational Spend Analytics
              </p>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/5 text-emerald-600 text-xs font-black">
