...
const LOGS: AuditLogEntry[] = [
  {
    ...
    action: "UPDATE",
    module: "Employees",
    record: "Employee #EMP-021 profile updated — Priya Sharma",
    ip: "10.0.0.12",
  ...
  },
  {
    ...
    action: "APPROVE",
    module: "Leave",
    record: "Leave #LV-0895 approved for Amit Verma (Apr 15–17)",
    ip: "10.0.0.12",
    device: "Chrome/Mac",
    severity: "info",
  },
  {
    ...
    action: "DELETE",
    module: "Employees",
    record: "Draft employee record DEL-024 deleted",
    ip: "192.168.1.45",
    device: "Chrome/Windows",
    severity: "critical",
    isFlagged: true,
  },
  {
    ...
    action: "UPDATE",
    module: "Attendance",
    record: "Attendance regularization submitted for Mar 28",
    ip: "10.0.0.15",
  ...
  },
  {
    ...
    action: "CREATE",
    module: "Recruitment",
    record: "Job requisition #REQ-042 created — Senior Developer",
    ip: "10.0.0.12",
    device: "Chrome/Mac",
    severity: "info",
  },
  {
    ...
    action: "SUBMIT",
    module: "Performance",
    record: "Performance review Q1 submitted for James Carter",
    ip: "10.0.0.12",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    ...
    action: "APPROVE",
    module: "Leave",
    record: "Leave #LV-0891 approved for Neha Singh",
    ip: "10.0.0.22",
    device: "Safari/Mac",
    severity: "info",
  },
  {
    id: "h8",
    timestamp: "Apr 5 4:20 PM",
    user: "Meera Thomas",
    userRole: "HR Manager",
    action: "EXPORT",
    module: "Recruitment",
    record: "Candidate shortlist exported — 28 candidates",
    ip: "10.0.0.12",
    device: "Chrome/Mac",
    severity: "warning",
    isFlagged: true,
  },
  {
    ...
    action: "UPDATE",
    module: "HR Settings",
    record: "Leave policy updated — sick leave max increased to 15 days",
    ip: "10.0.0.12",
    device: "Chrome/Windows",
    severity: "info",
    oldValue: "Sick leave max: 12 days",
    newValue: "Sick leave max: 15 days",
  },
  {
    id: "h10",
    ...
    action: "UPDATE",
    module: "Recruitment",
    record: "Candidate status changed — John Doe → Interview Scheduled",
    ip: "10.0.0.18",
    device: "Firefox/Linux",
    severity: "info",
  },
  {
    id: "h11",
    timestamp: "Apr 4 5:15 PM",
    user: "Meera Thomas",
    userRole: "HR Manager",
    action: "CREATE",
    module: "Onboarding",
    record: "Onboarding plan created for new hire EMP-056",
    ip: "10.0.0.12",
    device: "Chrome/Mac",
    severity: "info",
  },
  {
    id: "h12",
    timestamp: "Apr 4 3:00 PM",
    user: "Suresh Iyer",
    userRole: "HR Manager",
    action: "APPROVE",
    module: "Training",
    record: "Training request #TR-023 approved — AWS Certification",
    ip: "10.0.0.12",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    id: "h13",
    timestamp: "Apr 4 1:45 PM",
    user: "Priya Sharma",
    userRole: "HR Executive",
    action: "UPDATE",
    module: "Documents",
    record: "Document uploaded — EMP-021 Offer Letter signed",
    ip: "10.0.0.15",
    device: "Firefox/Linux",
    severity: "info",
  },
  {
    id: "h14",
    timestamp: "Apr 4 10:20 AM",
    user: "Unknown",
    userRole: "—",
    action: "VIEW",
    module: "Employees",
    record: "14 employee records bulk viewed from external IP",
    ip: "203.45.67.12",
    device: "Chrome/Windows",
    severity: "warning",
    isFlagged: true,
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-start gap-3 px-5 py-3.5 bg-[#E0F2FE] border-l-4 border-[#0EA5E9] rounded-xl">
        ...
        <div>
          <p className="text-[12px] font-bold text-[#0369A1]">
            You are viewing HR-related activity only.
          </p>
          <p className="text-[11px] font-medium text-[#0369A1]/80">
            System security, settings changes, and financial actions are not
            visible in your scope. Contact Super Admin for full audit access.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-6 px-5 py-3.5 bg-card border border-border rounded-2xl shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] font-bold text-foreground">
            {todayLogs} HR actions logged today
          </span>
        </div>
        <div className="flex items-center gap-2">
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div className="px-3 py-2 rounded-xl bg-[#E0F2FE] border border-[#0EA5E9]/20 flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-[#0369A1]">
                    Export limited to HR modules per your access scope.
                  </span>
                </div>
              </div>
