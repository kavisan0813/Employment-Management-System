          ...
          <div className="fixed inset-0 z-[2100] flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }} transition={{ type: "spring", damping: 20, stiffness: 300 }} className="relative w-full max-w-[440px] bg-card rounded-[32px] shadow-2xl border border-border overflow-hidden" onClick={e => e.stopPropagation()}>
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div>
                  <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest block mb-1.5">Modules (HR scope)</label>
                ...
                <div className="px-3 py-2 rounded-xl bg-[#E0F2FE] border border-[#0EA5E9]/20 flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-[#0369A1]">Export limited to HR modules per your access scope.</span>
                </div>
              </div>
