              ...
              <div className="flex items-center gap-4">
                <span
                  className={`px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${
                    item.color === "red"
                      ? "bg-rose-50 text-rose-500 border border-rose-100 dark:bg-rose-500/10"
                      : item.color === "amber"
                        ? "bg-amber-50 text-amber-600 border border-amber-100 dark:bg-amber-500/10"
