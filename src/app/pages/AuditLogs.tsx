  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-wrap items-center gap-6 px-5 py-3.5 bg-card border border-border rounded-2xl shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] font-bold text-foreground">
            {todayLogs} actions logged today
          </span>
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] font-bold text-foreground">
            1 critical security event — unauthorized access attempt (Apr 5)
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 bg-muted/10 p-4 rounded-2xl border border-border/50">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 text-[12px] font-black text-muted-foreground hover:text-foreground transition-all uppercase tracking-widest">
          <RotateCcw size={14} /> Reset
        </button>
        <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00B87C]/10 text-[#00B87C] font-black text-[12px] uppercase tracking-widest hover:bg-[#00B87C]/20 transition-all border border-[#00B87C]/20">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-[11px] font-black text-muted-foreground uppercase tracking-wider hover:bg-[#00B87C]/[0.08]/50 transition-all"
              >
                Dismiss
              </button>
              <button
      ...
      <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
        <div className="px-6 py-4 border-b border-border bg-card flex items-center justify-between">
          ...
          {flaggedFilter && (
            <button
              onClick={() => setFlaggedFilter(false)}
      ...
      <div className="flex items-center justify-between">
        <span className="text-[12px] font-bold text-muted-foreground">
          Showing 1–{logsPerPage} of 2,847 logs
        </span>
        <div className="flex items-center gap-1.5">
          <button className="w-8 h-8 rounded-xl border border-border flex items-center justify-center text-muted-foreground hover:bg-muted transition-all">
            <ChevronLeft size={16} />
          </button>
          <button className="w-8 h-8 rounded-xl bg-[#00B87C] text-white text-[12px] font-black flex items-center justify-center">
            1
          </button>
          <button className="w-8 h-8 rounded-xl border border-border text-[12px] font-bold text-muted-foreground hover:bg-muted transition-all flex items-center justify-center">
            2
          </button>
          <button className="w-8 h-8 rounded-xl border border-border text-[12px] font-bold text-muted-foreground hover:bg-muted transition-all flex items-center justify-center">
            3
          </button>
          <span className="text-[12px] font-bold text-muted-foreground px-1">
            ...
          </span>
          <button className="w-8 h-8 rounded-xl border border-border text-[12px] font-bold text-muted-foreground hover:bg-muted transition-all flex items-center justify-center">
            114
          ...
          <div className="fixed inset-0 z-[2100] flex items-center justify-center p-4">
            ...
            >
                ...
                {selectedLog.oldValue && selectedLog.newValue && (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-[12px] font-medium text-[#EF4444] bg-[#FEF2F2] px-3 py-2 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-[12px] font-medium text-[#00B87C] bg-[#F0FDF4] px-3 py-2 rounded-xl">
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div className="space-y-1.5">
                        {[
                          { t: "Today 10:40 AM", a: "VIEW", m: "Employees" },
                          { t: "Today 10:38 AM", a: "VIEW", m: "Employees" },
                          { t: "Today 10:35 AM", a: "LOGIN", m: "Auth" },
                        ].map((e, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-3 px-3 py-2 rounded-xl bg-muted/20 border border-border"
                          >
                            <span className="text-[11px] font-bold text-muted-foreground w-32">
                              {e.t}
                            </span>
                            <span
                              className={`px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-wider border ${getActionConfig(e.a as ActionType)?.chip || ""}`}
                            >
                              {e.a}
                            </span>
                            <span className="text-[11px] font-medium text-muted-foreground">
              ...
              <div className="px-6 py-4 border-t border-border bg-muted/5 flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <button className="px-3 py-2 rounded-xl border border-border text-[11px] font-semibold text-muted-foreground uppercase tracking-widest hover:bg-muted transition-all flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-2">
                  {selectedLog.severity !== "info" && (
                    <>
                      ...
                      <button className="px-3 py-2 rounded-xl bg-[#00B87C]/10 text-[#00B87C] text-[11px] font-semibold uppercase tracking-wider hover:bg-[#00B87C]/20 transition-all border border-[#00B87C]/20 flex items-center gap-1.5">
                        <Check size={13} /> Mark Reviewed
                      </button>
                    </>
                  )}
                  <button className="px-3 py-2 rounded-xl border border-[#EF4444]/30 text-[11px] font-semibold text-[#EF4444] uppercase tracking-widest hover:bg-[#EF4444]/5 transition-all flex items-center gap-1.5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[
                      ...
                      <button
                        key={m}
                        className="px-2.5 py-1 rounded-lg bg-[#00B87C]/10 text-[#00B87C] text-[11px] font-semibold border border-[#00B87C]/20"
                      >
                        {m}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {["CSV", "PDF", "Excel"].map((f) => (
                      <button
                        key={f}
                        className={`px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-wider border ${f === "CSV" ? "bg-[#00B87C] text-white border-[#00B87C]" : "border-border text-muted-foreground hover:border-[#00B87C]/50"}`}
                      >
                        {f}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {["All", "Critical only", "Warning+"].map((s) => (
                      <button
                        key={s}
                        className={`px-3 py-1.5 rounded-xl text-[11px] font-semibold uppercase tracking-wider border ${s === "All" ? "bg-[#00B87C] text-white border-[#00B87C]" : "border-border text-muted-foreground hover:border-[#00B87C]/50"}`}
                      >
                        {s}
                      </button>
                    ))}
          ...
          <div className="fixed inset-0 z-[2100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-6 py-5 space-y-4">
                <div>
                  ...
                  <div className="text-[11px] font-bold text-foreground mb-2">
                    When{" "}
                    <select className="px-3 py-1.5 rounded-lg border border-border bg-background text-[11px] font-bold mx-1">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      type="number"
                      defaultValue={3}
                      className="w-16 px-3 py-2 rounded-xl border border-border bg-background text-[12px] font-bold text-center outline-none focus:ring-2 focus:ring-[#00B87C]/20"
                    />
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {["Critical", "Warning"].map((s) => (
                      <button
                        key={s}
                        className={`px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-wider border ${s === "Critical" ? "bg-[#FEF2F2] text-[#EF4444] border-[#FECACA]" : "bg-[#FFFBEB] text-[#D97706] border-[#FDE68A]"}`}
                      >
                        {s}
                      </button>
                    ))}
                  ...
                  <div className="flex gap-4">
                    {["Email", "Push", "SMS"].map((n) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          defaultChecked={n !== "SMS"}
                          className="w-3.5 h-3.5 rounded border-border text-[#00B87C] focus:ring-[#00B87C]"
                        />
                        <span className="text-[12px] font-bold text-foreground">
                          {n}
                        </span>
              ...
              <div className="px-6 py-5 border-t border-border flex items-center justify-end gap-3">
                ...
                <button
                  onClick={() => setShowAlertModal(false)}
                  className="px-5 py-2.5 rounded-xl bg-[#00B87C] text-white text-[11px] font-semibold uppercase tracking-wider hover:opacity-90 transition-all shadow-sm"
                >
                  Save Alert Rule
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[2100] flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-[13px] font-medium text-muted-foreground mb-1">
                ...
                <strong className="text-foreground">45.123.67.89</strong>?
              </p>
