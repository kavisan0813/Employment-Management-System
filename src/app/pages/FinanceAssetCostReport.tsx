...
const ASSET_COST_BY_CATEGORY = [
  { id: "cat1", category: "Laptops", count: 85, totalValue: 10800000, annualDepreciation: 1800000, bookValue: 9000000, icon: "Laptop", status: "Active" },
  { id: "cat2", category: "Smartphones", count: 52, totalValue: 2600000, annualDepreciation: 520000, bookValue: 2080000, icon: "Smartphone", status: "Active" },
  { id: "cat3", category: "Monitors", count: 40, totalValue: 1200000, annualDepreciation: 200000, bookValue: 1000000, icon: "Monitor", status: "Active" },
  { id: "cat4", category: "Printers", count: 15, totalValue: 600000, annualDepreciation: 100000, bookValue: 500000, icon: "Printer", status: "Depreciating" },
  { id: "cat5", category: "Servers & Networking", count: 28, totalValue: 4800000, annualDepreciation: 960000, bookValue: 3840000, icon: "Wifi", status: "Critical" },
  { id: "cat6", category: "Accessories", count: 95, totalValue: 900000, annualDepreciation: 180000, bookValue: 720000, icon: "Watch", status: "Active" },
  { id: "cat7", category: "Vehicles", count: 8, totalValue: 3100000, annualDepreciation: 440000, bookValue: 2660000, icon: "Car", status: "Depreciating" },
];
...
const ASSET_DETAILS: Record<string, { items: { name: string; employee: string; dept: string; value: number; purchaseDate: string; lifeYears: number }[] }> = {
  cat1: { items: [
    { name: "MacBook Pro M4", employee: "Rahul Sharma", dept: "Engineering", value: 260000, purchaseDate: "Jan 2025", lifeYears: 5 },
    { name: "Dell XPS 16", employee: "Priya Patel", dept: "Design", value: 190000, purchaseDate: "Mar 2024", lifeYears: 4 },
    { name: "ThinkPad X1 Carbon", employee: "Amit Singh", dept: "Engineering", value: 220000, purchaseDate: "Jan 2024", lifeYears: 5 },
    { name: "HP EliteBook 840", employee: "Sneha Reddy", dept: "Marketing", value: 160000, purchaseDate: "Sep 2023", lifeYears: 4 },
    { name: "Surface Laptop 5", employee: "Vikram Mehta", dept: "Sales", value: 145000, purchaseDate: "Nov 2023", lifeYears: 4 },
  ]},
  cat2: { items: [
    { name: "iPhone 16 Pro", employee: "Ananya Gupta", dept: "Sales", value: 105000, purchaseDate: "Oct 2024", lifeYears: 3 },
    { name: "Samsung Galaxy S25", employee: "Rajesh Kumar", dept: "Operations", value: 95000, purchaseDate: "Feb 2025", lifeYears: 3 },
    { name: "Pixel 9 Pro", employee: "Neha Joshi", dept: "Marketing", value: 90000, purchaseDate: "Dec 2024", lifeYears: 3 },
  ]},
  cat3: { items: [
    { name: "Dell UltraSharp 27\"", employee: "Arun Nair", dept: "Engineering", value: 45000, purchaseDate: "Apr 2024", lifeYears: 5 },
    { name: "LG 4K Monitor 32\"", employee: "Deepa Iyer", dept: "Finance", value: 55000, purchaseDate: "Aug 2024", lifeYears: 5 },
  ]},
  cat4: { items: [
    { name: "HP LaserJet Pro", employee: "Common Area", dept: "Operations", value: 65000, purchaseDate: "Jan 2022", lifeYears: 5 },
    { name: "Canon imageRUNNER", employee: "Admin Pool", dept: "HR", value: 85000, purchaseDate: "Mar 2021", lifeYears: 5 },
  ]},
  cat5: { items: [
    { name: "Dell PowerEdge R750", employee: "IT Team", dept: "Engineering", value: 520000, purchaseDate: "Jan 2024", lifeYears: 6 },
    { name: "Cisco Switch Stack", employee: "IT Team", dept: "Engineering", value: 320000, purchaseDate: "Jun 2022", lifeYears: 6 },
    { name: "Synology NAS", employee: "IT Team", dept: "Engineering", value: 180000, purchaseDate: "Mar 2024", lifeYears: 5 },
  ]},
  cat6: { items: [
    { name: "Logitech MX Master 3S", employee: "Various", dept: "All", value: 12000, purchaseDate: "Jan 2024", lifeYears: 3 },
    { name: "Jabra Evolve2 65", employee: "Various", dept: "All", value: 18000, purchaseDate: "Feb 2024", lifeYears: 3 },
    { name: "Dell Dock WD19", employee: "Various", dept: "All", value: 22000, purchaseDate: "Mar 2024", lifeYears: 4 },
  ]},
  cat7: { items: [
    { name: "Toyota Innova Hycross", employee: "Executive Pool", dept: "Operations", value: 2800000, purchaseDate: "Jun 2024", lifeYears: 8 },
    { name: "Honda City Hybrid", employee: "Regional Sales", dept: "Sales", value: 1600000, purchaseDate: "Jan 2024", lifeYears: 7 },
  ]},
};

const DEPT_DETAILS: Record<string, { headCount: number; totalAssets: number; totalValue: number; avgAge: number }> = {
  "Engineering": { headCount: 180, totalAssets: 320, totalValue: 10800000, avgAge: 2.4 },
  "Sales": { headCount: 95, totalAssets: 140, totalValue: 4200000, avgAge: 1.8 },
  "Operations": { headCount: 72, totalAssets: 110, totalValue: 3500000, avgAge: 3.2 },
  "Marketing": { headCount: 48, totalAssets: 85, totalValue: 2800000, avgAge: 2.1 },
...
type KPIModalType = "totalValue" | "depreciation" | "maintenance" | "replacement" | null;
...
export function FinanceAssetCostReport() {
  ...
  const filteredData = [...ASSET_COST_BY_CATEGORY]
    ...
    .sort((a, b) => {
      ...
      switch (sortField) {
        ...
        case "annualDepreciation": cmp = a.annualDepreciation - b.annualDepreciation; break;
        case "bookValue": cmp = a.bookValue - b.bookValue; break;
  ...
  const SortIcon = ({ field }: { field: string }) => (
    <span className="inline-flex flex-col items-center leading-none ml-1 -mt-0.5">
      <ChevronDown size={8} className={`-mb-0.5 ${sortField === field && sortDir === "asc" ? "text-[#00B87C]" : "text-muted-foreground/40"}`} style={{ transform: "scaleY(-1)" }} />
      <ChevronDown size={8} className={`${sortField === field && sortDir === "desc" ? "text-[#00B87C]" : "text-muted-foreground/40"}`} />
    </span>
  );

  const selectedCategoryData = selectedCategory ? ASSET_COST_BY_CATEGORY.find(c => c.id === selectedCategory) : null;
  const selectedDetails = selectedCategory ? ASSET_DETAILS[selectedCategory] : null;
  ...
  const KPI_MODAL_CONTENT: Record<NonNullable<KPIModalType>, { title: string; icon: React.ElementType; color: string; bg: string; data: { label: string; value: string; color: string }[] }> = {
    totalValue: {
      ...
      bg: "#EDE9FE",
      data: [
        { label: "IT Equipment", value: formatCurrency(ASSET_COST_BY_CATEGORY.filter(c => ["Laptops", "Monitors", "Printers", "Servers & Networking"].includes(c.category)).reduce((s, c) => s + c.totalValue, 0)), color: "#8B5CF6" },
        { label: "Mobile Devices", value: formatCurrency(ASSET_COST_BY_CATEGORY.find(c => c.category === "Smartphones")?.totalValue || 0), color: "#0EA5E9" },
        { label: "Accessories", value: formatCurrency(ASSET_COST_BY_CATEGORY.find(c => c.category === "Accessories")?.totalValue || 0), color: "#F59E0B" },
        { label: "Vehicles", value: formatCurrency(ASSET_COST_BY_CATEGORY.find(c => c.category === "Vehicles")?.totalValue || 0), color: "#EF4444" },
      ]
    },
    depreciation: {
      ...
      bg: "#FEE2E2",
      data: [
        { label: "Straight Line Depreciation", value: formatCurrency(totalDepreciation * 0.75), color: "#EF4444" },
        { label: "Diminishing Balance", value: formatCurrency(totalDepreciation * 0.15), color: "#F59E0B" },
        { label: "Immediate Write-off", value: formatCurrency(totalDepreciation * 0.1), color: "#8B5CF6" },
      ]
    },
    maintenance: {
      ...
      bg: "#FEF3C7",
      data: [
        { label: "Hardware Repairs", value: formatCurrency(380000), color: "#F59E0B" },
        { label: "Software Licenses", value: formatCurrency(250000), color: "#8B5CF6" },
        { label: "Vendor Support", value: formatCurrency(170000), color: "#0EA5E9" },
      ]
    },
    replacement: {
      ...
      bg: "#FFF7ED",
      data: [
        { label: "Past Useful Life (Critical)", value: "5 assets", color: "#EF4444" },
        { label: "Nearing End of Life", value: "9 assets", color: "#F59E0B" },
        { label: "Recommended Budget", value: formatCurrency(6500000), color: "#8B5CF6" },
      ]
    }
  };
    ...
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-8 animate-in fade-in duration-500 min-h-screen bg-background">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <button
            onClick={() => navigate("/reports", { state: { activeTab: "Asset Reports" } })}
          ...
          <div>
            ...
            <p className="text-[13px] font-semibold text-muted-foreground">Asset valuation and depreciation overview</p>
          </div>
        </div>
      ...
      <div className="bg-card border border-border rounded-2xl p-4 flex flex-wrap items-center justify-between gap-4 shadow-sm">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            <button
              onClick={() => { setShowFYDropdown(!showFYDropdown); setShowCatDropdown(false); }}
              ...
              <div className="absolute top-full left-0 mt-2 w-48 bg-card border border-border rounded-2xl shadow-xl z-20 overflow-hidden">
                {["FY 2025-26", "FY 2024-25", "FY 2023-24"].map((fy) => (
                  ...
                  >
                    ...
                    {fy}
                    {selectedFY === fy && <CheckCircle2 size={14} className="ml-auto text-[#8B5CF6]" />}
                  </button>
                ))}
              </div>
            )}
          ...
          <div className="relative">
            <button
              onClick={() => { setShowCatDropdown(!showCatDropdown); setShowFYDropdown(false); }}
              className="flex items-center gap-2.5 px-4 py-2.5 bg-card border border-border rounded-xl text-[12px] font-bold text-foreground hover:border-[#8B5CF6]/50 transition-all shadow-sm"
            >
            ...
            {showCatDropdown && (
              <div className="absolute top-full left-0 mt-2 w-56 bg-card border border-border rounded-2xl shadow-xl z-20 overflow-hidden">
                {["All Categories", ...ASSET_COST_BY_CATEGORY.map(c => c.category)].map((cat) => (
                  <button
                    key={cat}
                  ...
                  >
                    ...
                    {cat}
                    {selectedCatFilter === cat && <CheckCircle2 size={14} className="ml-auto text-[#8B5CF6]" />}
                  </button>
                ))}
              </div>
            )}
          ...
          <button
            onClick={() => { setSearchQuery(""); setSelectedCatFilter("All Categories"); }}
      ...
      {(showFYDropdown || showCatDropdown) && (
        <div className="fixed inset-0 z-10" onClick={() => { setShowFYDropdown(false); setShowCatDropdown(false); }} />
      )}
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-3 text-right">
                      <span className="text-[13px] font-black text-foreground">{formatNumber(row.count)}</span>
                    </td>
                    <td className="px-6 py-3 text-right">
                      <span className="text-[13px] font-black text-foreground">{formatCurrency(row.totalValue)}</span>
                    </td>
                    <td className="px-6 py-3 text-right">
                      <span className="text-[13px] font-black text-rose-500">{formatCurrency(row.annualDepreciation)}</span>
                    </td>
                    <td className="px-6 py-3 text-right">
                      <span className="text-[13px] font-black text-[#00B87C]">{formatCurrency(row.bookValue)}</span>
                    </td>
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm font-bold text-muted-foreground">No categories found matching your search</p>
                    </div>
                  </td>
                </tr>
              )}
              ...
              <tfoot className="bg-[#EDE9FE]/20 dark:bg-purple-500/5 border-t-2 border-[#8B5CF6]/20 dark:border-purple-500/20">
                <tr>
                  ...
                  <td className="px-6 py-4 text-right">
                    <span className="text-[13px] font-black text-foreground">{formatNumber(filteredData.reduce((s, r) => s + r.count, 0))}</span>
                  </td>
                  <td className="px-6 py-4 text-right">
                    <span className="text-[13px] font-black text-[#8B5CF6]">{formatCurrency(filteredData.reduce((s, r) => s + r.totalValue, 0))}</span>
                  </td>
                  <td className="px-6 py-4 text-right">
                    <span className="text-[13px] font-black text-rose-500">{formatCurrency(filteredData.reduce((s, r) => s + r.annualDepreciation, 0))}</span>
                  </td>
                  <td className="px-6 py-4 text-right">
        ...
        <div className="p-4 bg-card border border-border rounded-2xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base font-black text-foreground">{ASSET_COST_BY_CATEGORY.length}</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-card border border-border rounded-2xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">Active Categories</p>
              <p className="text-base font-black text-foreground">{ASSET_COST_BY_CATEGORY.filter(c => c.status === "Active").length}</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-card border border-border rounded-2xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base font-black text-foreground">{Math.round(totalDepreciation / totalAssetValue * 100)}%</p>
            </div>
          </div>
        </div>
        <div className="p-4 bg-card border border-border rounded-2xl shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-base font-black text-foreground">{ASSET_VALUE_BY_DEPT.length}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-card border border-border rounded-[32px] shadow-sm flex flex-col h-full">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => {
                const total = ASSET_VALUE_BY_DEPT.reduce((s, d) => s + d.total, 0);
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              {ASSET_VALUE_BY_DEPT.map((dept) => {
                const maxVal = Math.max(...ASSET_VALUE_BY_DEPT.map(d => d.total));
                ...
                return (
                  ...
                  >
                    <span className="w-24 text-[11px] font-bold text-muted-foreground shrink-0 text-right group-hover:text-foreground transition-colors">{dept.department}</span>
          ...
          <div className="flex-1 w-full h-[320px]">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis dataKey="department" type="category" axisLine={false} tickLine={false} tick={{ fontSize: 11, fontWeight: 700, fill: "#94A3B8" }} width={80} />
                <Tooltip
                  cursor={{ fill: "rgba(139,92,246,0.05)" }}
                  contentStyle={{ backgroundColor: "#0F3047", border: "none", borderRadius: "12px", color: "white" }}
                  formatter={(value: number, name: string) => [`₹${value}L`, name === "depreciated" ? "Depreciated" : "Book Value"]}
                />
                <Bar dataKey="depreciated" name="depreciated" fill="#8B5CF6" radius={[0, 4, 4, 0]} barSize={16} cursor="pointer" onClick={(data) => data?.department && setSelectedDept(data.department)} />
                <Bar dataKey="current" name="current" fill="#00B87C" radius={[0, 4, 4, 0]} barSize={16} cursor="pointer" onClick={(data) => data?.department && setSelectedDept(data.department)} />
              </RechartsBarChart>
            </ResponsiveContainer>
          </div>
        </div>
            ...
            >
              ...
              >
                <div className="px-8 py-6 border-b border-border flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center border-2" style={{ backgroundColor: modal.bg, color: modal.color, borderColor: `${modal.color}40` }}>
                      <Icon size={24} />
                    </div>
                    <div>
                      <h2 className="text-lg font-black text-foreground tracking-tight">{modal.title}</h2>
                      <p className="text-[12px] font-semibold text-muted-foreground">Detailed breakdown</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setActiveKPIModal(null)}
            ...
            >
              <div className="px-8 py-6 border-b border-border flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-lg font-black text-foreground tracking-tight">{selectedCategoryData.category}</h2>
                    <p className="text-[12px] font-semibold text-muted-foreground">{selectedCategoryData.count} assets assigned</p>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedCategory(null)}
              ...
              <div className="px-8 py-4 bg-secondary/10 border-b border-border flex items-center gap-8">
                <div>
                  <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">Total Value</p>
                  <p className="text-sm font-black text-foreground">{formatCurrency(selectedCategoryData.totalValue)}</p>
                </div>
                <div>
                  <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">Annual Depreciation</p>
                  <p className="text-sm font-black text-rose-500">{formatCurrency(selectedCategoryData.annualDepreciation)}</p>
                </div>
                <div>
                  <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">Book Value</p>
                  <p className="text-sm font-black text-[#00B87C]">{formatCurrency(selectedCategoryData.bookValue)}</p>
                </div>
                <div>
                  <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">Status</p>
                  <div className="mt-0.5">{getStatusBadge(selectedCategoryData.status)}</div>
                </div>
              </div>
              ...
              <div className="px-8 py-6 border-b border-border flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] font-semibold text-muted-foreground">Department Asset Overview</p>
                  </div>
                </div>
                <button
                  onClick={() => setSelectedDept(null)}
              ...
              <div className="px-8 py-6 space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-muted/20 border border-border">
                    <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest mb-1">Head Count</p>
                    <p className="text-xl font-black text-foreground">{formatNumber(selectedDeptData.headCount)}</p>
                  </div>
                  <div className="p-4 rounded-2xl bg-muted/20 border border-border">
                  ...
                  <div className="p-4 rounded-2xl bg-muted/20 border border-border">
                    ...
                    <p className="text-xl font-black text-amber-500">{selectedDeptData.avgAge} yrs</p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl border border-border bg-muted/10">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex-1 h-3 bg-secondary rounded-full overflow-hidden">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: `${Math.min((selectedDeptData.totalAssets / selectedDeptData.headCount) * 10, 100)}%` }}
                        transition={{ duration: 0.8 }}
                        className="h-full rounded-full"
                        style={{ backgroundColor: DEPT_ASSET_DIST_DATA.find(d => d.department === selectedDept)?.color || "#8B5CF6" }}
                      />
                    </div>
                    <span className="text-[11px] font-black text-foreground shrink-0">{(selectedDeptData.totalAssets / selectedDeptData.headCount).toFixed(1)} per person</span>
                  </div>
                </div>
              </div>
