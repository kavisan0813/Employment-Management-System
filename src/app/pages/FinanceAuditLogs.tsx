...
const LOGS: AuditLogEntry[] = [
  {
    ...
    action: "RUN",
    module: "Payroll",
    record: "Payroll April 2026 processing initiated — 284 employees",
    ip: "10.0.0.8",
  ...
  },
  {
    ...
    action: "APPROVE",
    module: "Expenses",
    record: "Expense #EXP-4231 approved — ₹45,000 — James Carter",
    ip: "10.0.0.9",
    device: "Safari/Mac",
    severity: "info",
  },
  {
    ...
    record: "Quarterly budget report exported — external IP detected",
    ip: "203.45.67.89",
    device: "Chrome/Windows",
    severity: "critical",
    isFlagged: true,
  },
  {
    ...
    record: "TAX slab updated for FY 2026-27 — new regime",
    ip: "10.0.0.8",
    device: "Chrome/Windows",
    severity: "info",
    oldValue: "Old regime: 20% slab at ₹12L",
    newValue: "New regime: 20% slab at ₹15L",
  },
  {
    id: "f5",
    ...
    action: "APPROVE",
    module: "Increment",
    record: "Increment approved for Meera Thomas — 12% raise",
    ip: "10.0.0.9",
    device: "Safari/Mac",
    severity: "info",
  },
  {
    ...
    userRole: "Finance",
    action: "PROCESS",
    module: "F&F Settlement",
    record: "F&F settlement processed — Priya Sharma — ₹1,51,000",
    ip: "10.0.0.8",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    ...
    action: "APPROVE",
    module: "Expenses",
    record: "Bulk expense approval — 12 travel claims — ₹2,34,000",
    ip: "10.0.0.9",
    device: "Safari/Mac",
    severity: "warning",
    isFlagged: true,
  },
  {
    ...
    action: "REJECT",
    module: "Expenses",
    record: "Expense #EXP-4189 rejected — ₹12,000 — out of policy",
    ip: "10.0.0.8",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    ...
    action: "VIEW",
    module: "Finance Reports",
    record: "Salary budget report accessed by HR",
    ip: "10.0.0.12",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    ...
    action: "UPDATE",
    module: "Increment",
    record: "Bulk increment spreadsheet uploaded for FY 2026-27",
    ip: "10.0.0.8",
    device: "Chrome/Windows",
    severity: "info",
  },
  {
    id: "f11",
    timestamp: "Apr 4 5:00 PM",
    user: "Rahul Verma",
    userRole: "Finance",
    action: "DELETE",
    module: "Payroll Settings",
    record: "Archived payroll template 'FY2025-Old' deleted",
    ip: "10.0.0.9",
    device: "Safari/Mac",
    severity: "info",
  },
  {
    id: "f12",
    timestamp: "Apr 4 2:30 PM",
    user: "Ananya Das",
    userRole: "Finance",
    action: "RUN",
    module: "Payroll",
    record: "Payroll dry run completed — no errors detected",
    ip: "10.0.0.8",
    device: "Chrome/Windows",
    severity: "info",
  },
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-start gap-3 px-5 py-3.5 bg-[#EDE9FE] border-l-4 border-[#8B5CF6] rounded-xl">
        ...
        <div>
          <p className="text-[12px] font-bold text-[#6D28D9]">
            You are viewing Finance-related activity only.
          </p>
          <p className="text-[11px] font-medium text-[#6D28D9]/80">
            HR, recruitment, and system settings are not visible in your scope.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-6 px-5 py-3.5 bg-card border border-border rounded-2xl shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] font-bold text-foreground">
            {todayLogs} finance actions logged today
          </span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <KPICard
          title="FINANCE ACTIONS TODAY"
          value="124"
          sub="across all finance modules"
          color="green"
          icon={FileText}
        />
        <KPICard
          title="FLAGGED (FINANCE)"
          value="0"
        ...
        />
        <KPICard
          title="EXPENSE APPROVALS LOGGED"
          value="36"
          sub="this month"
          color="amber"
          icon={CheckCircle2}
                      ...
                      <button
                        onClick={() => {
                          showToast(
                            "Log Flagged",
                            "warning",
                            "Log marked for further investigation.",
                          );
                          setSelectedLog(null);
                        }}
              ...
              <div className="px-6 py-5 space-y-4">
                ...
                <div className="px-3 py-2 rounded-xl bg-[#EDE9FE] border border-[#8B5CF6]/20 flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-bold text-[#6D28D9]">
                    Export limited to Finance modules per your access scope.
                  </span>
                </div>
              </div>
                ...
                <button
                  onClick={() => {
                    ...
                    showToast(
                      "IP Blocked",
                      "success",
                      "The IP address has been permanently blocked.",
                    );
                  }}
