  ...
  const KPI_CARDS = [
    {
      ...
      accent: "#059669",
      route: "/employees",
      spark: [60, 65, 70, 68, 72, 75, 80, 78, 82, 85, 88, 92],
    },
    {
      title: "Present Today",
      value: "219",
      ...
      accent: "#22C55E",
      route: "/attendance",
      spark: [70, 72, 75, 73, 76, 80, 82, 85, 83, 87, 88, 90],
    },
    {
      title: "Pending Actions",
      value: wfCounts.pending.toString(),
      trend: "-1.2%",
      up: false,
      ...
      accent: "#F59E0B",
      route: "/leave",
      spark: [30, 28, 25, 27, 24, 22, 20, 21, 19, 17, 18, 17],
    },
    {
      ...
      accent: "#8B5CF6",
      route: "/recruitment",
      spark: [10, 11, 12, 13, 14, 13, 15, 16, 15, 17, 18, 18],
    },
  ];
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 pb-10">
          ...
          >
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `radial-gradient(ellipse at top right, ${card.accent}0A 0%, transparent 65%)`,
                pointerEvents: "none",
              }}
            />
            {/* Left border accent */}
            ...
            >
              <button
                style={{
                  ...
                  border: "none",
                  background:
                    openMenu === i ? "var(--secondary)" : "transparent",
                  color: "var(--muted-foreground)",
                  cursor: "pointer",
                  display: "flex",
                  alignItems: "center",
              ...
              {openMenu === i && (
                ...
                >
                  {[
                    ["View Details", card.route],
                    ["Go to Module", card.route],
                  ].map(([lbl, rt], idx) => (
                    <button
                      key={idx}
                      onClick={() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 mb-5">
        ...
        <div
          className="lg:col-span-3 rounded-2xl p-6 shadow-sm"
          style={{
            backgroundColor: "var(--card)",
            border: "1px solid var(--border)",
          }}
              ...
              {(["6M", "1Y", "2Y"] as const).map((f) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    backgroundColor:
                      trendFilter === f ? "var(--primary)" : "var(--secondary)",
                    color:
                      trendFilter === f ? "white" : "var(--muted-foreground)",
                ...
                >
                  {departmentHeadcount.map((_entry, index) => (
                    <Cell
                      ...
                      opacity={
                        activePie === null || activePie === index ? 1 : 0.4
                      }
                      stroke="none"
                    />
                  ))}
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      padding: "1px 6px",
                      borderRadius: "6px",
                      backgroundColor: `${deptColors[i % deptColors.length]}18`,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
        ...
        >
          ...
          >
            ...
            >
              {attendanceOverview.find((a) => a.name === "Present")?.value ??
                219}{" "}
              / 248 &nbsp;·&nbsp;
              {Math.round(
                ((attendanceOverview.find((a) => a.name === "Present")?.value ??
                    ...
                    style={{
                      ...
                      backgroundColor:
                        state === "approved"
                          ? "rgba(5,150,105,0.06)"
                          : "rgba(239,68,68,0.06)",
                      border: `1px solid ${state === "approved" ? "rgba(5,150,105,0.25)" : "rgba(239,68,68,0.25)"}`,
                    }}
                  >
                    {state === "approved" ? (
        ...
        >
          ...
          >
            ...
            >
              3 upcoming birthdays this week
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        >
          ...
          >
            {["Employee", "Role", "Department", "Joined", "Status"].map(
              (col) => (
                <span
                  key={col}
                  style={{
                  ...
                  style={{
                    ...
                    backgroundColor:
                      hire.status === "Active"
                        ? "rgba(5,150,105,0.1)"
                        : "rgba(245,158,11,0.1)",
                    color: hire.status === "Active" ? "#059669" : "#F59E0B",
                  }}
                >
                  {hire.status}
                </span>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontWeight: 700,
                    color:
                      hoveredAction === i ? action.color : "var(--foreground)",
                    lineHeight: 1.3,
                  }}
                >
                  {action.label}
            ...
            {recentActivities.slice(0, 3).map((activity) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {Icon && (
                      <Icon size={11} style={{ color: activity.color }} />
                    )}
                  </div>
                  <p
                    style={{
