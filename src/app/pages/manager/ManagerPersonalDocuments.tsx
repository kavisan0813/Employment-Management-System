...
function DocumentPreviewContent({ docName }: { docName: string }) {
    ...
    return (
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-white to-slate-50 text-slate-800 rounded-2xl border-2 border-emerald-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex justify-between items-start border-b border-emerald-500/30 pb-2">
          <div>
            <p className="text-[10px] font-extrabold text-emerald-800 tracking-wide leading-none">Government of India</p>
            <p className="text-[8px] text-slate-500 font-bold mt-0.5 leading-none">Unique Identification Authority of India</p>
          </div>
          <div className="text-right">
            <span className="bg-emerald-600 text-white text-[7px] px-1.5 py-0.5 rounded-full font-black uppercase tracking-wider">Aadhaar</span>
          </div>
        </div>
        ...
        <div className="flex gap-4 my-2.5 items-center flex-1">
          ...
          <div className="space-y-1 text-[9.5px] font-bold text-slate-700">
            <p className="text-[11px] font-black text-slate-900 leading-tight">Suresh Iyer</p>
            <p><span className="text-slate-400">DOB:</span> 22/07/1985</p>
            <p><span className="text-slate-400">Gender:</span> Male</p>
            <p className="text-[8px] leading-tight text-slate-500 font-normal"><span className="font-bold text-slate-600">Address:</span> 42, Nungambakkam High Road, Chennai 600034</p>
          </div>
        </div>

        {/* Bottom Number */}
        <div className="border-t border-emerald-500/30 pt-2 flex flex-col items-center justify-center">
          <p className="text-[14px] font-black text-slate-900 tracking-widest leading-none">9824 1042 5632</p>
          <p className="text-[7px] text-emerald-700 font-black tracking-widest mt-1 uppercase">Mera Aadhaar, Meri Pehchan</p>
        </div>
        
        {/* Subtle Watermark logo */}
        <div className="absolute right-2 bottom-6 opacity-5 pointer-events-none">
          <svg width="60" height="60" viewBox="0 0 24 24" fill="currentColor" className="text-orange-500">
    ...
    return (
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-950 text-white rounded-2xl border border-teal-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex justify-between items-start border-b border-white/20 pb-2">
          <div>
            <p className="text-[9px] font-black tracking-wider uppercase text-emerald-400">Income Tax Department</p>
            <p className="text-[7px] text-slate-300 tracking-widest uppercase">Govt. Of India</p>
          </div>
          <span className="text-[7px] font-black uppercase text-emerald-400 border border-emerald-400/40 px-1 py-0.5 rounded">Permanent Account Number</span>
        </div>
        ...
        <div className="flex gap-4 my-2 items-center flex-1">
          ...
          <div className="space-y-1 text-[9px] font-bold text-slate-200">
            <p className="text-[11px] font-black text-white leading-tight">SURESH IYER</p>
            <p><span className="text-slate-400 uppercase text-[8px]">Father's Name:</span> M. IYER</p>
            <p><span className="text-slate-400 uppercase text-[8px]">Date of Birth:</span> 22/07/1985</p>
            <p className="text-[12px] font-black text-emerald-400 tracking-wider mt-1.5">ABCPG4321I</p>
          </div>
        </div>
  ...
  if (nameLower.includes("passport")) {
    return (
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-900 text-white rounded-2xl border border-indigo-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex justify-between items-start border-b border-white/20 pb-2">
          <div>
            <p className="text-[9px] font-black tracking-wider uppercase text-amber-400">Republic of India</p>
            <p className="text-[7px] text-slate-300 tracking-widest uppercase">Passport / पारपत्र</p>
          </div>
          <span className="text-[10px] font-black tracking-wider text-amber-400">IND</span>
        </div>
        ...
        <div className="flex gap-4 my-2 items-center flex-1">
          ...
          <div className="space-y-1 text-[8.5px] font-bold text-slate-300">
            <p className="text-[10px] font-black text-white leading-tight">IYER SURESH</p>
            <p><span className="text-slate-400">Nationality:</span> INDIAN</p>
            <p><span className="text-slate-400">Sex:</span> M</p>
            <p><span className="text-slate-400">DOB:</span> 22 JUL 1985</p>
            <p><span className="text-slate-400">Passport No:</span> Z1024563</p>
            <p className="text-[7.5px] text-amber-400/80">Expiry Date: 12 JAN 2029</p>
          </div>
        </div>
  ...
  if (nameLower.includes("letter") || nameLower.includes("nda") || nameLower.includes("appraisal")) {
    return (
      <div className="w-full aspect-[3/4] bg-white text-slate-800 rounded-2xl border border-slate-200 shadow-md p-6 flex flex-col justify-between text-left font-serif select-none relative">
        ...
        <div className="border-b-2 border-[#00B87C] pb-3 text-center font-sans">
          <h4 className="text-[14px] font-black text-[#00B87C] uppercase tracking-widest">NexusHR Technologies</h4>
          <p className="text-[7px] text-slate-500 font-bold uppercase tracking-wider mt-0.5">Innovating Human Resources</p>
        </div>
        ...
        <div className="flex-1 my-4 space-y-3">
          ...
          <h5 className="text-[10px] font-extrabold text-slate-900 uppercase text-center tracking-wide font-sans">{docName}</h5>
          ...
          <p className="text-[8px] leading-relaxed text-slate-600">
            {nameLower.includes("offer") && "We are pleased to offer you the position of Engineering Manager at NexusHR Technologies. Your leadership experience and architecture expertise will drive our technical excellence."}
            {nameLower.includes("appointment") && "This letter serves to confirm your formal appointment as Engineering Manager. You report to Sarah Mitchell, VP HR, and will oversee our engineering organization based in Chennai."}
            {nameLower.includes("nda") && "This Non-Disclosure Agreement governs the confidentiality of proprietary engineering designs, codebase resources, client datasets, and internal corporate information."}
            {nameLower.includes("appraisal") && "Based on your exceptional performance rating of 4.6/5 and high completion rate of 1048 tasks, your appraisal cycle review confirms an increment in tenure benefits."}
          </p>

          <p className="text-[8px] leading-relaxed text-slate-600">
            Please review the details regarding work parameters and department standards. We look forward to your continued contribution.
          </p>
        </div>
        ...
        <div className="flex justify-between items-end border-t border-slate-100 pt-3 font-sans">
          <div>
            <p className="text-[7px] font-black text-slate-800">Sarah Mitchell</p>
            <p className="text-[6px] text-slate-500 font-bold uppercase">VP, Human Resources</p>
          </div>
          <div className="text-right">
            <span className="inline-block border border-emerald-500/20 bg-emerald-50 text-[6px] text-[#00B87C] font-black uppercase px-2 py-0.5 rounded shadow-sm">Officially Signed</span>
          </div>
        </div>
      </div>
    );
  ...
  if (nameLower.includes("certificate") || nameLower.includes("degree")) {
    return (
      <div className="w-full aspect-[4/3] bg-[#FCFBF7] text-slate-800 rounded-2xl border-4 border-double border-amber-800/20 shadow-md p-6 flex flex-col justify-between text-center font-serif select-none relative">
        ...
        <h4 className="text-[13px] font-extrabold tracking-widest text-amber-900 uppercase">Board of Technical Education</h4>
        <p className="text-[7px] text-slate-500 font-bold uppercase tracking-wider -mt-1 font-sans">Tamil Nadu, India</p>

        <div className="my-2 space-y-1.5">
          <p className="text-[8px] italic text-slate-600 font-sans">This is to certify that</p>
          <p className="text-[13px] font-extrabold text-slate-900 tracking-wide font-serif">Suresh Iyer</p>
          <p className="text-[8px] leading-relaxed text-slate-600">
            has successfully completed the program of study and passed the examinations prescribed for the degree of
          </p>
          <p className="text-[11px] font-extrabold text-amber-900 tracking-wide font-serif">Bachelor of Engineering</p>
          <p className="text-[8px] font-bold text-slate-500 font-sans">in Information Technology</p>
        </div>
        ...
        <div className="flex justify-between items-end border-t border-slate-200/50 pt-2 font-sans text-[7px] font-bold text-slate-600">
          <div>
            <p className="italic text-slate-400">Class: First Class with Distinction</p>
  ...
  return (
    <div className="w-full aspect-[3/4] bg-secondary rounded-2xl border border-border p-6 flex flex-col justify-between text-left font-sans select-none relative">
      ...
      <div className="flex-1 my-6 flex flex-col justify-center gap-1.5">
        ...
        <p className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider">EMPLOYEE RECORD</p>
        <div className="h-px bg-border/50 my-2" />
        <div className="space-y-1 text-[11px] text-muted-foreground font-semibold">
          <p><span className="text-slate-400">Owner:</span> Suresh Iyer</p>
          <p><span className="text-slate-400">Uploaded:</span> Yes</p>
          <p><span className="text-slate-400">Verification Date:</span> Jan 12, 2026</p>
          <p><span className="text-slate-400">File Type:</span> Secured Document</p>
        </div>
      </div>
