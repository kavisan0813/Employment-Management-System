      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 bg-card p-4 rounded-2xl border border-border shadow-sm">
        <div className="flex flex-col sm:flex-row items-center gap-4 flex-1">
          ...
          <div className="relative w-full sm:w-48">
            ...
            <ChevronRight
              className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground rotate-90"
              size={16}
            />
          </div>
        </div>
            ...
            >
              ...
              <div className="px-6 mt-8">
                <div className="flex items-center gap-4 border-b border-border">
                  {["Overview", "Attendance", "Leave", "Performance"].map(
                    (tab) => (
                      <button
                        key={tab}
              ...
              <div className="flex-1 overflow-y-auto p-6 no-scrollbar">
                {activeTab === "Overview" && (
                  <div className="space-y-6">
                            ...
                            <span
                              className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded ${
                                leave.status === "Approved"
                                  ? "text-[#00B87C] bg-emerald-50 dark:bg-emerald-500/10"
                    ...
                    <div>
                      <h4 className="text-[11px] font-bold text-foreground uppercase tracking-wider mb-4 flex items-center gap-2">
                        <Clock size={14} className="text-[#00B87C]" /> Recent
                        Activity
                      </h4>
                      <div className="space-y-4 ml-2 border-l border-border pl-4">
                        {[
                          ...
                          {
                            time: "2 days ago",
                            text: "Completed Security Training",
                          },
                        ].map((item, i) => (
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <div
                          key={i}
                          className="p-4 rounded-2xl border border-border bg-card flex flex-col items-center"
                        >
                    ...
                    <div className="p-4 rounded-2xl border border-border bg-card">
                      <h4 className="text-[11px] font-bold text-foreground uppercase tracking-wider mb-4">
                        May 2026
                      </h4>
                        ...
                        >
                          ...
                          <div className="w-full h-1 bg-secondary rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${(parseInt(bal.value) / parseInt(bal.total)) * 100}%`,
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div
                            key={i}
                            className="p-3 rounded-xl border border-border bg-secondary/20 flex items-center justify-between"
                          >
                            <div>
                              <p className="text-xs font-bold text-foreground">
                                {req.type}
                  ...
                  <div className="space-y-6">
                        ...
                        {[1, 2, 3, 4, 5].map((s) => (
                          <Star
                            ...
                            className={
                              s <=
                              Math.floor(
                                parseFloat(selectedEmployee.performance),
                              )
                    ...
                    <div>
                      <h4 className="text-[11px] font-bold text-foreground uppercase tracking-wider mb-4 flex items-center justify-between">
                        Goal Progress
                        <span className="text-[#00B87C] cursor-pointer hover:underline">
                          View All
                        </span>
                      </h4>
