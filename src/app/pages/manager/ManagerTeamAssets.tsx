...
const TEAM_DATA: TeamMember[] = [
  {
    ...
    assets: [
      { id: "a1", assetId: "AST-001", name: "MacBook Pro M3", category: "Laptop", serialNo: "SN-MBP-00123", value: "₹1,99,900", status: "Assigned", assignedDate: "15 Jan 2025", condition: "Good", notes: "Primary development machine" },
      { id: "a2", assetId: "AST-008", name: "Dell 27\" Monitor", category: "Monitor", serialNo: "SN-MON-0045", value: "₹32,500", status: "Assigned", assignedDate: "15 Jan 2025", condition: "Good", notes: "External display" },
    ],
  },
  {
    id: "EMP-0145",
    ...
    department: "Engineering",
    assets: [
      { id: "a3", assetId: "AST-002", name: "MacBook Pro M2", category: "Laptop", serialNo: "SN-MBP-00234", value: "₹1,49,900", status: "Assigned", assignedDate: "10 Feb 2025", condition: "Excellent", notes: "Frontend dev machine" },
      { id: "a4", assetId: "AST-015", name: "iPhone 15 Pro", category: "Smartphone", serialNo: "SN-IPH-0078", value: "₹1,34,900", status: "Assigned", assignedDate: "10 Feb 2025", condition: "Excellent", notes: "Mobile testing device" },
    ],
  },
  {
    id: "EMP-0148",
    ...
    department: "Engineering",
    assets: [
      { id: "a5", assetId: "AST-003", name: "Lenovo ThinkPad X1", category: "Laptop", serialNo: "SN-LEN-00567", value: "₹1,25,000", status: "Assigned", assignedDate: "01 Mar 2025", condition: "Fair", notes: "Needs upgrade soon" },
    ],
  },
  {
    id: "EMP-0150",
    ...
    department: "Engineering",
    assets: [
      { id: "a6", assetId: "AST-004", name: "MacBook Pro M3 Max", category: "Laptop", serialNo: "SN-MBP-00345", value: "₹2,49,900", status: "Assigned", assignedDate: "20 Dec 2024", condition: "Excellent", notes: "High-performance machine" },
      { id: "a7", assetId: "AST-012", name: "Logitech MX Keys", category: "Accessories", serialNo: "SN-LOG-0023", value: "₹12,500", status: "Pending Return", assignedDate: "20 Dec 2024", condition: "Good", notes: "Resigned — pending collection" },
    ],
  },
  {
    id: "EMP-0152",
    ...
    department: "Engineering",
    assets: [
      { id: "a8", assetId: "AST-005", name: "MacBook Pro M3", category: "Laptop", serialNo: "SN-MBP-00456", value: "₹1,99,900", status: "Assigned", assignedDate: "05 Jan 2025", condition: "Excellent", notes: "Primary machine" },
      { id: "a9", assetId: "AST-010", name: "Samsung 32\" Monitor", category: "Monitor", serialNo: "SN-MON-0067", value: "₹45,000", status: "Assigned", assignedDate: "05 Jan 2025", condition: "Good", notes: "Ultrawide display" },
      { id: "a10", assetId: "AST-020", name: "HP LaserJet Printer", category: "Printer", serialNo: "SN-HP-0012", value: "₹28,000", status: "Assigned", assignedDate: "15 Jan 2025", condition: "Good", notes: "Shared team printer" },
    ],
  },
];
...
const PENDING_REQUESTS: PendingRequest[] = [
  {
    ...
    reason: "Need additional screen for development work. Current single monitor setup is affecting productivity.",
    urgency: "High",
...
function getCategoryColor(category: string): { bg: string; text: string; border: string } {
  switch (category) {
    ...
    case "Accessories": return { bg: "#FCE7F3", text: "#EC4899", border: "#FBCFE8" };
...
export function ManagerTeamAssets() {
  ...
  const [selectedAsset, setSelectedAsset] = useState<{ member: TeamMember; asset: TeamAsset } | null>(null);
  ...
  const totalValue = TEAM_DATA.reduce((sum, m) =>
    sum + m.assets.reduce((s, a) => {
  ...
  const pendingReturnCount = allAssets.filter(a => a.status === "Pending Return").length;
    ...
    <div className="p-8 max-w-[1600px] mx-auto min-h-screen">
      ...
      <div className="flex flex-wrap items-center gap-6 mb-6 px-5 py-3 bg-card border border-border rounded-2xl shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[13px] font-bold text-foreground">{membersWithAssets} team members have assets</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-[#F59E0B]" />
          <span className="text-[13px] font-bold text-foreground">{pendingReturnCount} pending return</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-[#0EA5E9]" />
          <span className="text-[13px] font-bold text-foreground">{pendingRequests.length} asset request{pendingRequests.length !== 1 ? "s" : ""} pending</span>
        </div>
      </div>
                  ...
                  <tr key={item.id} className="hover:bg-[#00B87C]/[0.08] transition-colors h-16 group">
                    ...
                    <td className="px-6 py-3">
                      ...
                      >
                        ...
                        <div>
                          <p className="text-[13px] font-bold text-foreground group-hover:text-[#00B87C] transition-colors">{item.name}</p>
                          <p className="text-[11px] font-medium text-muted-foreground">{item.assetId}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-3">
                      <span className="text-[13px] font-bold text-muted-foreground">{item.category}</span>
                    </td>
                    <td className="px-6 py-3">
                ...
                <tr>
                  <td colSpan={7} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-sm font-bold text-muted-foreground">No assets found matching your search</p>
                    </div>
                  </td>
                </tr>
              )}
      ...
      <div className="mb-8">
        ...
        {pendingRequests.length === 0 ? (
          <div className="bg-card border border-dashed border-border rounded-2xl p-10 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">There are no pending asset requests to review.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-muted-foreground">{req.submittedDate}</span>
                  </div>
                </div>
              ...
              <div className="p-8 pb-0 text-center flex flex-col items-center">
                <div
                  ...
                  style={{
                    ...
                    borderColor: getCategoryColor(selectedAsset.asset.category).border,
                  }}
                >
