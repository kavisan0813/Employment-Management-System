...
export function FinanceSchedule() {
  ...
  const [showShiftDetails, setShowShiftDetails] = useState<ShiftCell | null>(
    null,
  );
  ...
  const handleRequestSwap = (e: React.FormEvent) => {
    ...
    showToast(
      "Success",
      "success",
      `Swap request submitted successfully to ${colleagueName}.`,
    );
    ...
    <div className="w-full px-4 md:px-8 py-6 pb-20 space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[26px] font-bold text-foreground tracking-tight m-0 leading-none">
              My Schedule
            </h1>
            <p className="text-[13px] text-[#6B7280] mt-1">
              Your personal shift schedule
            </p>
          </div>
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-[12px] font-semibold text-[#94A3B8] uppercase tracking-wider ml-2">
            WEEKLY GRID
          </h3>
          <div className="bg-card border border-border rounded-[32px] overflow-hidden shadow-sm">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-border">
                ...
                >
                  <td className="px-6 py-4 text-[13px] font-black text-foreground whitespace-nowrap">
                    Apr 6
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 rounded-full text-[11px] font-semibold bg-emerald-500/10 text-[#00B87C] uppercase tracking-widest border border-emerald-500/20">
                      MORNING
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 text-[13px] font-bold text-muted-foreground whitespace-nowrap">
                    HQ Office
                  </td>
                </tr>
                <tr
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2 py-0.5 rounded bg-amber-500/10 text-amber-600 text-[11px] font-semibold uppercase">
                      2.5 hrs OT
                    </span>
                  </td>
                  <td className="px-6 py-4 text-[13px] font-bold text-muted-foreground whitespace-nowrap">
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2.5 py-1 rounded-full text-[11px] font-semibold bg-amber-500/10 text-[#F59E0B] uppercase tracking-widest border border-amber-500/20">
                      EVENING
                    </span>
                  </td>
                  <td className="px-6 py-4 text-[13px] font-bold text-foreground whitespace-nowrap">
          ...
          {swapRequests.length === 0 ? (
            ...
            <div className="space-y-3">
              {swapRequests.map((req) => (
                <div
                  key={req.id}
                  className="bg-card border border-border rounded-2xl p-5 shadow-sm space-y-3 relative hover:border-[#00B87C]/30 transition-all"
                >
                  <div className="flex justify-between items-center">
                    <span className="text-[12px] font-black text-[#00B87C] tracking-wider bg-emerald-500/5 px-2 py-0.5 rounded border border-emerald-500/10">
                      {req.id}
                    </span>
                    <span className="px-2 py-0.5 rounded text-[11px] font-semibold bg-amber-500/10 text-amber-600 uppercase border border-amber-500/20">
                      {req.status}
                    </span>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] font-bold text-muted-foreground">
                      Colleague's Shift: {req.theirShift}
                    </p>
                  </div>
              ...
              <form onSubmit={handleRequestSwap} className="p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="w-full px-4 py-3 rounded-2xl bg-muted/30 border border-border flex items-center gap-3">
                    <span className="px-2 py-0.5 rounded text-[11px] font-semibold bg-emerald-500/10 text-[#00B87C] uppercase border border-emerald-500/20">
                      MORNING
                    </span>
                    <span className="text-[13px] font-bold text-foreground">
                      Apr 7 (Tue) · 06:00 – 14:00
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="Evening Shift (14:00 - 22:00)">
                      Evening Shift (14:00 - 22:00)
                    </option>
                    <option value="Night Shift (22:00 - 06:00)">
                      Night Shift (22:00 - 06:00)
                    </option>
                    <option value="Morning Shift (06:00 - 14:00)">
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#F0FDF4] border border-[#00B87C]/30 dark:bg-[#00B87C]/5">
                  ...
                  <p className="text-[12px] font-black text-[#00B87C]">
                    Your manager Rajan Kumar will be notified for approval
                  </p>
                </div>
        ...
        {showShiftDetails && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-[320px] bg-card border border-border rounded-2xl shadow-xl p-5 flex flex-col items-center text-center"
            >
              <h3 className="text-[16px] font-black text-foreground mb-1">
                {showShiftDetails.type} Shift
              </h3>
              <p className="text-[13px] font-bold text-muted-foreground mb-4">
                {showShiftDetails.day}, {showShiftDetails.date} ·{" "}
                {showShiftDetails.time}
              </p>
              <button
                onClick={() => setShowShiftDetails(null)}
                className="px-5 py-2 rounded-xl bg-muted text-foreground text-[12px] font-black uppercase"
              >
                Close
              </button>
            </motion.div>
