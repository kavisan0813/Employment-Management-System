      ...
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-white to-slate-50 text-slate-800 rounded-2xl border-2 border-emerald-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex gap-4 my-2.5 items-center flex-1">
          ...
          <div className="space-y-1 text-[9.5px] font-bold text-slate-700">
            <p className="text-[11px] font-black text-slate-900 leading-tight">Priya Sharma</p>
            <p><span className="text-slate-400">DOB:</span> 15/08/1995</p>
            <p><span className="text-slate-400">Gender:</span> Female</p>
            <p className="text-[8px] leading-tight text-slate-500 font-normal"><span className="font-bold text-slate-600">Address:</span> Flat 402, Green Meadows, Velachery, Chennai - 600042</p>
          </div>
        </div>

        {/* Bottom Number */}
        <div className="border-t border-emerald-500/30 pt-2 flex flex-col items-center justify-center">
          <p className="text-[14px] font-black text-slate-900 tracking-widest leading-none">5482 1902 4321</p>
      ...
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-950 text-white rounded-2xl border border-teal-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex gap-4 my-2 items-center flex-1">
          ...
          <div className="space-y-1 text-[9px] font-bold text-slate-200">
            <p className="text-[11px] font-black text-white leading-tight">PRIYA SHARMA</p>
            <p><span className="text-slate-400 uppercase text-[8px]">Father's Name:</span> RAJESH SHARMA</p>
            <p><span className="text-slate-400 uppercase text-[8px]">Date of Birth:</span> 15/08/1995</p>
            <p className="text-[12px] font-black text-emerald-400 tracking-wider mt-1.5">BPWPS1234P</p>
          </div>
        </div>
      ...
      <div className="w-full aspect-[3/2] bg-gradient-to-br from-indigo-950 via-slate-900 to-indigo-900 text-white rounded-2xl border border-indigo-500/20 shadow-lg p-5 flex flex-col justify-between relative overflow-hidden text-left font-sans select-none">
        ...
        <div className="flex gap-4 my-2 items-center flex-1">
          ...
          <div className="space-y-1 text-[8.5px] font-bold text-slate-300">
            <p className="text-[10px] font-black text-white leading-tight">SHARMA PRIYA</p>
            <p><span className="text-slate-400">Nationality:</span> INDIAN</p>
            <p><span className="text-slate-400">Sex:</span> F</p>
            <p><span className="text-slate-400">DOB:</span> 15 AUG 1995</p>
            <p><span className="text-slate-400">Passport No:</span> Z7654321</p>
            <p className="text-[7.5px] text-amber-400/80">Expiry Date: 20 JUN 2031</p>
          </div>
        </div>
      ...
      <div className="w-full aspect-[3/4] bg-white text-slate-800 rounded-2xl border border-slate-200 shadow-md p-6 flex flex-col justify-between text-left font-serif select-none relative">
        ...
        <div className="flex-1 my-4 space-y-3">
          ...
          <p className="text-[8px] leading-relaxed text-slate-600">
            {nameLower.includes("offer") && "We are pleased to offer you the position of Senior Frontend Developer at NexusHR Technologies. Your expertise and passion will be a tremendous asset to our engineering division."}
            {nameLower.includes("appointment") && "This letter serves to confirm your formal appointment as Senior Frontend Developer. You will report to Arjun Reddy and will be based out of our Chennai operations."}
            ...
            {nameLower.includes("appraisal") && "Based on your exceptional performance rating of 4.5/5 and high completion rate of 924 tasks, your appraisal cycle review confirms an increment in tenure benefits."}
          </p>
    ...
    return (
      <div className="w-full aspect-[4/3] bg-[#FCFBF7] text-slate-800 rounded-2xl border-4 border-double border-amber-800/20 shadow-md p-6 flex flex-col justify-between text-center font-serif select-none relative">
        ...
        <div className="my-2 space-y-1.5">
          ...
          <p className="text-[13px] font-extrabold text-slate-900 tracking-wide font-serif">Priya Sharma</p>
          <p className="text-[8px] leading-relaxed text-slate-600">
            has successfully completed the program of study and passed the examinations prescribed for the degree of
          </p>
          <p className="text-[11px] font-extrabold text-amber-900 tracking-wide font-serif">Bachelor of Technology</p>
          <p className="text-[8px] font-bold text-slate-500 font-sans">in Computer Science and Engineering</p>
        </div>
    ...
    <div className="w-full aspect-[3/4] bg-secondary rounded-2xl border border-border p-6 flex flex-col justify-between text-left font-sans select-none relative">
      ...
      <div className="flex-1 my-6 flex flex-col justify-center gap-1.5">
        ...
        <div className="space-y-1 text-[11px] text-muted-foreground font-semibold">
          <p><span className="text-slate-400">Owner:</span> Priya Sharma</p>
