...
const DEADLINES = [
  ...
  },
  {
    ...
    date: "Apr 15",
    status: "Active",
    desc: "In progress — Action required",
  },
  {
    title: "Payroll Lock",
    date: "Apr 20",
  ...
  const handleRunPayrollConfirm = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        addToast(
          "success",
          "Payroll for April 2026 has been initiated successfully!",
        );
      }, 1200);
    }, 2000);
  };
    ...
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-6">
      ...
      <div className="w-full py-3 px-4 rounded-2xl bg-[#DCFCE7]/40 dark:bg-emerald-500/5 border border-emerald-100/50 dark:border-emerald-500/10 shadow-sm backdrop-blur-sm overflow-x-auto">
        <div className="flex items-center gap-2 flex-nowrap min-w-max">
          {[
            {
              color: "#F59E0B",
              text: "Payroll due: April 28",
              action: () => openModal("runPayroll"),
            },
            {
              color: "#EF4444",
              text: "36 pending expense approvals",
              action: () => navigate("/expenses"),
            },
            {
              color: "#EF4444",
              text: "TDS filing deadline: April 15",
              action: () => openModal("tdsInfo"),
            },
            {
              color: "#F59E0B",
            ...
            >
              ...
              <span
                ...
                style={{
                  color: item.color === "#F59E0B" ? "#92400E" : "#991B1B",
                }}
              >
                {item.text}
              </span>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-[26px] font-bold text-[#111827] dark:text-white">
              Finance Dashboard
            </h2>
            <p className="text-[13px] text-[#6B7280]">
              Payroll, expenses and financial overview
            </p>
          </div>
        </div>
        ...
        {[
          ...
          >
            ...
            <p
              ...
              style={{
                color:
                  kpi.color === "#111827" ? "var(--foreground)" : kpi.color,
              }}
            >
              {kpi.label === "PENDING EXPENSES" ? "₹42.8K" : kpi.value}
            </p>
            <p className="text-[12px] text-[#6B7280]">
              {kpi.label === "PENDING EXPENSES"
                ? `${pendingCount} claims`
                : kpi.sub}
            </p>
          </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-[11px] font-bold text-muted-foreground mt-1">
                Salary expenditure across financial year
              </p>
            </div>
        ...
        <div className="bg-card p-6 rounded-2xl border border-border shadow-sm flex flex-col">
          <h3 className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider mb-6">
                ...
                >
                  {COMPONENT_BREAKDOWN.map((entry, index) => (
                    <Cell
                      ...
                      strokeWidth={0}
                      opacity={
                        activeSegment === null || activeSegment === index
                          ? 1
                          : 0.4
                      }
          ...
          <div className="mt-4 space-y-3">
            {COMPONENT_BREAKDOWN.map((item, i) => (
              <div
                ...
                style={{
                  opacity:
                    activeSegment === null || activeSegment === i ? 1 : 0.5,
                }}
              >
                <div className="flex items-center gap-3">
                  <div
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 rounded bg-emerald-50 dark:bg-emerald-500/10 text-[9px] font-black text-emerald-600 dark:text-emerald-400">
                    ↑ 1.2%
                  </span>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
            <h3 className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider mb-10">
              Payroll Processing Status
            </h3>
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-50 dark:bg-emerald-500/5 border border-emerald-100 dark:border-emerald-500/10 w-fit">
              ...
              <span className="text-[12px] font-bold text-[#00B87C]">
                Current Stage: Calculation in progress
              </span>
            </div>
          </div>
                ...
                <thead>
                  <tr className="bg-[#F9FAFB] dark:bg-white/5">
                    {[
                      ...
                      <th
                        key={h}
                        className={`px-6 py-4 text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider ${h === "Action" ? "text-right" : ""}`}
                      >
                        {h}
                      </th>
                    ))}
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Upcoming Deadlines */}
          <div className="bg-card p-6 rounded-2xl border border-border shadow-sm">
            <h3 className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider mb-8">
              Upcoming Deadlines
            </h3>
              ...
              {DEADLINES.map((item, i) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    else if (item.title === "TDS Filing")
                      openModal("deadlineTDS");
                    else if (item.title === "Payroll Lock")
                      openModal("deadlinePayrollLock");
                    else if (item.title === "Payroll Run")
                      openModal("runPayroll");
                  }}
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <p
                        className={`text-[14px] font-black ${item.status === "Active" ? "text-[#3B82F6]" : "text-foreground"}`}
                      >
                        {item.title}
                      </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                },
                {
                  ...
                  color: "#64748B",
                  bg: "#F3F4F6",
                  action: () => openModal("salaryRegister"),
                },
                {
                  icon: Download,
      ...
      <Modal
        open={modals.approveExpense}
        onClose={() => closeModal("approveExpense")}
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => closeModal("approveExpense")}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-[#00B87C] text-white font-bold text-[13px] hover:bg-[#009F6B] transition-colors"
                >
                  Confirm Approve
                </button>
              </div>
      ...
      <Modal
        open={modals.rejectExpense}
        onClose={() => closeModal("rejectExpense")}
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-[18px] font-black text-foreground">
            ...
            <button
              onClick={() => closeModal("rejectExpense")}
              className="p-2 rounded-xl hover:bg-muted transition-colors text-muted-foreground"
            >
              <X size={18} />
            </button>
          ...
          {selectedExpense && (
            <div className="space-y-4">
              <div className="p-3 rounded-xl border border-border bg-muted/20 flex justify-between items-center">
                <span className="text-[13px] font-bold text-foreground">
                  {selectedExpense.employee} — {selectedExpense.category}
                </span>
          ...
          <div className="flex items-center gap-2 mb-6">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex items-center gap-2">
                ...
                {s < 3 && (
                  <div
                    className={`h-[2px] w-12 rounded-full transition-all ${payrollStep > s ? "bg-[#00B87C]" : "bg-border"}`}
                  />
                )}
              </div>
            ))}
            <span className="text-[12px] font-bold text-muted-foreground ml-2">
              Step {payrollStep} of 3
            </span>
          </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2 p-4 rounded-xl border border-border bg-muted/20">
                  ...
                  <p className="text-[22px] font-black text-[#8B5CF6]">
                    ₹2.87 Cr
                  </p>
                </div>
              </div>
              <div className="space-y-2">
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      className={`text-[13px] font-semibold ${c.ok ? "text-[#047857]" : "text-amber-700"}`}
                    >
                      {c.label}
                    </span>
                    {c.warn && (
              ...
              <button
                ...
                className="w-full py-3 rounded-xl bg-[#00B87C] text-white font-bold text-[13px] hover:bg-[#009F6B] transition-colors flex items-center justify-center gap-2"
              >
                  ...
                  <thead className="bg-muted/30">
                    <tr>
                      {[
                        ...
                        <th
                          key={h}
                          className="px-4 py-3 text-[10px] font-black text-muted-foreground uppercase tracking-widest"
                        >
                          {h}
                        </th>
                      ))}
                  ...
                  <tbody className="divide-y divide-border">
                    {PAYROLL_DEPT_SUMMARY.map((r, i) => (
                      <tr key={i} className="hover:bg-muted/20">
                        ...
                        <td className="px-4 py-3 text-[12px] font-black text-[#00B87C]">
                          {r.net}
                        </td>
                      </tr>
                    ))}
              ...
              {!payrollDone ? (
                <>
                  <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 flex gap-3">
                    ...
                    <p className="text-[13px] font-semibold text-amber-800 dark:text-amber-200">
                      ...
                      <strong>1,284 employees</strong>. This action cannot be
                      undone.
                    </p>
                  </div>
                  {payrollRunning ? (
                ...
                <div className="flex flex-col items-center gap-3 py-6">
                  ...
                  <p className="text-[13px] text-muted-foreground text-center">
                    April 2026 payroll has been queued for processing.
                  </p>
                </div>
              )}
            </div>
      ...
      {/* Step Detail Modal */}
      <Modal
        open={modals.stepModal}
        onClose={() => closeModal("stepModal")}
        maxWidth="440px"
      >
        <div className="p-7">
          ...
          <button
            onClick={() => closeModal("stepModal")}
            className="w-full mt-6 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
          >
            Close
          </button>
        </div>
        ...
        <div className="p-7">
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20">
              <p className="text-[13px] font-bold text-red-700 dark:text-red-300">
                ⚠️ Deadline: April 15, 2026 (10 days remaining)
              </p>
            </div>
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              TDS (Tax Deducted at Source) quarterly filing for Q4 FY 2025-26
              (Jan–Mar 2026) is due by April 15. Late filing attracts a penalty
              of ₹200/day.
            </p>
            <div className="p-3 rounded-xl border border-border bg-muted/20 space-y-2">
              ...
              <div className="flex justify-between text-[12px]">
                ...
                <span className="font-black text-foreground">1,284</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                  Total TDS
                </span>
                <span className="font-black text-[#8B5CF6]">₹18.4L</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                  Status
                </span>
                <span className="font-black text-[#3B82F6]">In Progress</span>
              </div>
            </div>
          </div>
          <div className="flex gap-3 mt-5">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-[#3B82F6] text-white font-bold text-[13px] hover:bg-blue-600 transition-colors"
            >
              View TDS Report
            </button>
          </div>
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20">
              <p className="text-[13px] font-bold text-amber-700 dark:text-amber-300">
                📅 Due Date: April 20, 2026 (14 days remaining)
              </p>
            </div>
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              Employee Provident Fund (EPF) contribution for March 2026 payroll
              must be remitted to EPFO by April 20, 2026.
            </p>
            <div className="p-3 rounded-xl border border-border bg-muted/20 space-y-2">
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                ...
                <span className="font-black text-foreground">₹11.5L</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                  Employer PF (12%)
              ...
              <div className="flex justify-between text-[12px]">
                ...
                <span className="font-black text-[#F59E0B]">₹23.0L</span>
              </div>
            </div>
          </div>
          <div className="flex gap-3 mt-5">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-[#F59E0B] text-white font-bold text-[13px] hover:bg-amber-600 transition-colors"
            >
              View PF Report
            </button>
          </div>
      ...
      {/* Payroll Lock Modal */}
      <Modal
        open={modals.payrollLock}
        onClose={() => closeModal("payrollLock")}
        maxWidth="440px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => closeModal("payrollLock")}
              className="p-2 rounded-xl hover:bg-muted transition-colors text-muted-foreground"
            >
              <X size={18} />
            </button>
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20">
              <p className="text-[13px] font-bold text-[#1D4ED8] dark:text-blue-300">
                🔒 Lock Date: April 20, 2026 (14 days away)
              </p>
            </div>
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              All attendance, leave, and compensation adjustments must be
              finalized before this date. After payroll lock, no changes can be
              made to the April 2026 payroll inputs.
            </p>
            <div className="p-3 rounded-xl border border-border bg-muted/20 space-y-2">
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                ...
                <span className="font-black text-amber-600">12 requests</span>
              </div>
              <div className="flex justify-between text-[12px]">
                <span className="text-muted-foreground font-semibold">
                  Pending expense approvals
              ...
              <div className="flex justify-between text-[12px]">
                ...
                <span className="font-black text-foreground">Apr 28, 2026</span>
              </div>
            </div>
          </div>
          <button
            onClick={() => closeModal("payrollLock")}
            className="w-full mt-5 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
          >
            Close
          </button>
        </div>
      ...
      {/* YTD Report Modal */}
      <Modal
        open={modals.ytdReport}
        onClose={() => closeModal("ytdReport")}
        maxWidth="620px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-6">
          ...
          <div className="p-3 rounded-xl bg-[#EDE9FE] dark:bg-purple-500/10 border border-purple-100 dark:border-purple-500/20 mb-4 flex justify-between items-center">
            <span className="text-[12px] font-bold text-[#8B5CF6]">
              Total YTD Payroll Cost
            </span>
            <span className="text-[20px] font-black text-[#8B5CF6]">
              ₹3.2 Cr
            </span>
          </div>
          <div className="overflow-x-auto rounded-xl border border-border">
              ...
              <tbody className="divide-y divide-border">
                {YTD_MONTHLY.map((r, i) => (
                  <tr key={i} className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3 text-[12px] font-black text-[#8B5CF6]">
                      {r.amount}
                    </td>
                    <td className="px-4 py-3 text-[12px] font-semibold text-muted-foreground">
          ...
          <div className="flex gap-3 mt-5">
            ...
            <button
              onClick={() => {
                closeModal("ytdReport");
                addToast("success", "YTD Payroll Report downloaded.");
              }}
              className="flex-1 py-3 rounded-xl bg-[#8B5CF6] text-white font-bold text-[13px] hover:bg-violet-700 transition-colors flex items-center justify-center gap-2"
            >
      ...
      {/* TDS Report Modal */}
      <Modal
        open={modals.tdsReport}
        onClose={() => closeModal("tdsReport")}
        maxWidth="600px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-6">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  <tr key={i} className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3 text-[12px] font-black text-red-500">
                      {r.tds}
                    </td>
                    <td className="px-4 py-3">
                      <span className="px-2 py-0.5 rounded bg-blue-50 dark:bg-blue-500/10 text-[#3B82F6] text-[10px] font-black">
                        {r.cert}
                      </span>
                    </td>
                  </tr>
          ...
          <div className="flex gap-3">
            <button
              onClick={() => {
                addToast("success", "TDS Report (Excel) downloaded.");
                closeModal("tdsReport");
              }}
              className="flex-1 py-3 rounded-xl bg-[#00B87C] text-white font-bold text-[13px] hover:bg-[#009F6B] transition-colors flex items-center justify-center gap-2"
            >
              <Download size={16} /> Download Excel
            ...
            <button
              onClick={() => {
                addToast("success", "TDS Report (PDF) downloaded.");
                closeModal("tdsReport");
              }}
              className="flex-1 py-3 rounded-xl bg-[#3B82F6] text-white font-bold text-[13px] hover:bg-blue-600 transition-colors flex items-center justify-center gap-2"
            >
              <FileText size={16} /> Download PDF
            </button>
            <button
              onClick={() => closeModal("tdsReport")}
              className="px-5 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
            >
              ✕
            </button>
          </div>
      ...
      {/* PF Report Modal */}
      <Modal
        open={modals.pfReport}
        onClose={() => closeModal("pfReport")}
        maxWidth="560px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-6">
          ...
          <div className="overflow-x-auto rounded-xl border border-border mb-5">
            <table className="w-full text-left">
              <thead className="bg-muted/30">
                <tr>
                  {["Employee", "UAN", "Emp PF", "Employer PF", "Total"].map(
                    (h) => (
                      <th
                        key={h}
                        className="px-4 py-3 text-[10px] font-black text-muted-foreground uppercase tracking-widest"
              ...
              <tbody className="divide-y divide-border">
                {[
                  ...
                  <tr key={i} className="hover:bg-muted/20">
                    ...
                    <td className="px-4 py-3 text-[12px] font-black text-[#F59E0B]">
                      {r.total}
                    </td>
                  </tr>
                ))}
          ...
          <div className="flex gap-3">
            <button
              onClick={() => {
                addToast("success", "PF ECR file downloaded.");
                closeModal("pfReport");
              }}
              className="flex-1 py-3 rounded-xl bg-[#F59E0B] text-white font-bold text-[13px] hover:bg-amber-600 transition-colors flex items-center justify-center gap-2"
            >
              <Download size={16} /> Download ECR
            </button>
            <button
              onClick={() => closeModal("pfReport")}
              className="px-5 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
      ...
      <Modal
        open={modals.salaryRegister}
        onClose={() => closeModal("salaryRegister")}
        maxWidth="440px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => closeModal("salaryRegister")}
              className="p-2 rounded-xl hover:bg-muted transition-colors text-muted-foreground"
            >
              <X size={18} />
            </button>
          ...
          <p className="text-[13px] text-muted-foreground mb-4">
            Download the full salary register for March 2026 containing detailed
            breakdowns for all 1,284 employees.
          </p>
          <div className="p-4 rounded-xl border border-border bg-muted/20 space-y-2 mb-5">
            <div className="flex justify-between text-[12px]">
              ...
              <span className="font-black text-foreground">March 2026</span>
            </div>
            <div className="flex justify-between text-[12px]">
              <span className="text-muted-foreground font-semibold">
                Employees
            ...
            <div className="flex justify-between text-[12px]">
              ...
              <span className="font-black text-[#8B5CF6]">₹28.4L</span>
            </div>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() => {
                addToast("success", "Salary Register downloaded.");
                closeModal("salaryRegister");
              }}
              className="flex-1 py-3 rounded-xl bg-[#64748B] text-white font-bold text-[13px] hover:bg-slate-600 transition-colors flex items-center justify-center gap-2"
            >
              ...
              <div className="p-4 rounded-xl border border-border bg-muted/20 space-y-2 text-[12px]">
                ...
                <div className="border-t border-border pt-2 mt-2 space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-red-500">₹78,000</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Net Taxable</span>
                    <span className="font-bold text-[#00B87C]">₹10,62,000</span>
                  </div>
                </div>
              </div>
              <div className="flex gap-3">
            ...
            <div className="space-y-4">
              ...
              {!form16Done ? (
                ...
                <div className="flex flex-col items-center gap-3 py-4">
                  ...
                  <p className="text-[12px] text-muted-foreground text-center">
                    1,284 Form 16 documents generated successfully.
                  </p>
                  <button
                    onClick={() => {
                      addToast(
      ...
      {/* PF Deadline */}
      <Modal
        open={modals.deadlinePF}
        onClose={() => closeModal("deadlinePF")}
        maxWidth="400px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="p-4 rounded-xl bg-[#DCFCE7] dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 mb-4">
            <p className="text-[13px] font-black text-[#047857]">
              ✅ Completed on schedule — April 10, 2026
            </p>
          </div>
          <p className="text-[13px] text-muted-foreground">
            PF remittance of ₹23.0L was successfully processed and credited to
            EPFO on April 10, 2026. ECR challan no: ECR-2026-04-001.
          </p>
          <button
            onClick={() => closeModal("deadlinePF")}
            className="w-full mt-5 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
      ...
      {/* TDS Deadline */}
      <Modal
        open={modals.deadlineTDS}
        onClose={() => closeModal("deadlineTDS")}
        maxWidth="400px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => closeModal("deadlineTDS")}
              className="p-2 rounded-xl hover:bg-muted transition-colors text-muted-foreground"
            >
              <X size={18} />
            </button>
          ...
          <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 mb-4">
            <p className="text-[13px] font-black text-[#1D4ED8] dark:text-blue-300">
              🔵 In Progress — Action Required by Apr 15
            </p>
          </div>
          <p className="text-[13px] text-muted-foreground">
            Q4 FY 2025-26 TDS return (24Q) is currently being prepared. Total
            TDS: ₹18.4L across 1,284 employees. Please ensure filing before the
            deadline.
          </p>
          <div className="flex gap-3 mt-5">
            <button
      ...
      <Modal
        open={modals.deadlinePayrollLock}
        onClose={() => closeModal("deadlinePayrollLock")}
        maxWidth="400px"
      >
        <div className="p-7">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={() => closeModal("deadlinePayrollLock")}
              className="p-2 rounded-xl hover:bg-muted transition-colors text-muted-foreground"
            >
              <X size={18} />
            </button>
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-500/10 border border-slate-100 dark:border-slate-500/20 mb-4">
            <p className="text-[13px] font-black text-muted-foreground">
              ○ Upcoming — April 20, 2026
            </p>
          </div>
          <p className="text-[13px] text-muted-foreground">
            All input data for April 2026 payroll must be finalized by this
            date. Ensure all leave, attendance regularizations, and expense
            approvals are completed before the lock.
          </p>
          <button
            onClick={() => closeModal("deadlinePayrollLock")}
            className="w-full mt-5 py-3 rounded-xl border border-border text-foreground font-bold text-[13px] hover:bg-muted transition-colors"
