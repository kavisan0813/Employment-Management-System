  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 pb-10 space-y-6 relative">
      ...
      <div className="w-full py-3 px-6 rounded-2xl bg-emerald-50/50 border border-emerald-100 flex flex-wrap items-center gap-8 shadow-sm">
        ...
        <button 
          onClick={() => navigate("/recruitment")}
          className="flex items-center gap-2 border-l border-emerald-200/50 pl-8 hover:opacity-80 transition-opacity cursor-pointer text-left bg-transparent border-none p-0 outline-none"
        >
          <div className="w-2 h-2 rounded-full bg-emerald-500" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { icon: Users, label: "TOTAL EMPLOYEES", value: "1,284", sub: "Active count", color: "#10B981", bg: "#DCFCE7", path: "/employees" },
          { icon: UserCheck, label: "NEW HIRES", value: "24", sub: "Last 30 days", color: "#8B5CF6", bg: "#EDE9FE", path: "/onboarding" },
          { icon: UserX, label: "ATTRITION RATE", value: "1.2%", sub: "Last month: 1.4%", color: "#EF4444", bg: "#FEE2E2", path: "/offboarding" },
          { icon: Briefcase, label: "OPEN POSITIONS", value: "18", sub: "5 high priority", color: "#F59E0B", bg: "#FEF3C7", path: "/recruitment" },
        ].map((kpi, i) => (
          <motion.div 
            key={i}
        ...
        <div className="lg:col-span-2 bg-card p-6 rounded-2xl border border-border shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <select 
              ...
              className="bg-secondary text-[11px] font-bold px-3 py-1 rounded-lg border-none outline-none cursor-pointer"
            >
