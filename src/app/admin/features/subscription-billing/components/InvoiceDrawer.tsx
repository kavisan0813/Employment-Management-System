      ...
      >
        ...
        <div className="p-4 bg-gray-50 border-t border-gray-200 flex gap-2">
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3.5 py-2.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-700 hover:bg-gray-50 cursor-pointer"
          >
