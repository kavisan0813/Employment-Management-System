...
export function BillingDashboard({ onNavigateTab }: BillingDashboardProps) {
  ...
  const totalSubscribers = activePlans.reduce(
      ...
      <div className="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-semibold">
            A comprehensive overview of billing performance, active plans, and
            upcoming renewals.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {[
            ...
            },
            {
              ...
              val: String(subStats?.totalActive || 0),
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-xs font-semibold">
            ...
            <div className="p-4 space-y-3">
              {activePlans.map((plan) => {
                const pct =
                  totalSubscribers > 0
                    ? (plan.subscriberCount / totalSubscribers) * 100
                    : 0;
                const barColor =
