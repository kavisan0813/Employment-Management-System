              ...
              {filteredInvoices.length === 0 ? (
                ...
                filteredInvoices.map((inv) => {
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-3 font-mono font-semibold text-gray-700">{inv.invoiceNumber}</td>
                      <td className="px-4 py-3 font-medium text-gray-900">{inv.organizationName}</td>
                      <td className="px-4 py-3 text-gray-600">${inv.amount.toLocaleString()}</td>
                      <td className="px-4 py-3 text-gray-400">${inv.tax.toLocaleString()}</td>
                      <td className="px-4 py-3 font-semibold text-gray-900">${inv.totalAmount.toLocaleString()}</td>
                      <td className="px-4 py-3 text-gray-500">{inv.issuedDate}</td>
                      <td className="px-4 py-3 text-gray-500">{inv.dueDate}</td>
                      <td className="px-4 py-3">
                        <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md border text-[11px] font-medium ${cfg.class}`}>
