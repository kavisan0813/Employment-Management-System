...
export function RenewalTrackingPage() {
  ...
  const { handleChangePlan, handleCancel, handleReactivate } =
    useSubscriptions();
      ...
      <div className="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-semibold">
            Monitor upcoming subscription renewals and proactively manage
            retention.
          </p>
        </div>
      </div>
          ...
          {[
            {
              ...
              val: renewals.length.toString(),
              sub: `in the next ${daysAhead} days`,
              icon: FileText,
              bg: "bg-indigo-50",
            ...
            },
            {
              ...
              val: `$${renewals.reduce((sum, r) => sum + r.amount, 0).toLocaleString()}`,
              ...
              val: renewals
                .filter((r) => {
                  ...
                  const days = Math.ceil(
                    (new Date(r.renewalDate).getTime() - Date.now()) /
                      (1000 * 60 * 60 * 24),
                  );
                  return days <= 7;
                })
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p
                    className={`text-xs font-semibold ${m.text} opacity-60 mt-1`}
                  >
                    {m.sub}
                  </p>
                </div>
