      ...
      <div className="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-semibold">
            Manage active organizational plans, trials, and subscription
            statuses.
          </p>
        </div>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-start">
                    <span
                      className={`text-xs font-semibold uppercase tracking-wider ${m.text} opacity-70`}
                    >
                      {m.label}
                    </span>
                  ...
                  <div>
                    <h4
                      className={`text-xl font-semibold ${m.text} tracking-tight`}
                    >
                      {m.val}
                    </h4>
                    <p
                      className={`text-xs font-medium ${m.text} opacity-60 mt-1`}
                    >
                      {m.sub}
                    </p>
                  </div>
              ...
              <tbody className="divide-y divide-gray-100 text-sm">
                {filteredSubs.length === 0 ? (
                  ...
                  filteredSubs.map((sub) => (
                    ...
                    >
                      <td className="px-5 py-4 font-mono font-semibold text-gray-500">
                        {sub.id}
                      </td>
                      ...
                      <td className="px-5 py-4">
                        <span
                          className={`inline-flex px-2.5 py-1 rounded-full border text-xs font-semibold ${planBadgeClass(sub.planTier)}`}
                        >
                          {sub.planTier}
                        </span>
                      </td>
                      ...
                      <td className="px-5 py-4">
                        <span
                          className={`inline-flex px-2.5 py-1 rounded-full border text-xs font-semibold ${statusBadgeClass(sub.status)}`}
                        >
                          {sub.status}
                        </span>
                      </td>
