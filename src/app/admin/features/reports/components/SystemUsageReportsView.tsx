import { Activity, Smartphone, HardDrive } from "lucide-react";
      ...
      <div className="p-6 flex-1 overflow-y-auto flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {activeUsers.map((u) => (
            <div
              key={u.label}
              className="bg-indigo-50/50 border border-indigo-100 rounded-xl p-4 space-y-2"
            >
          ...
          <div className="border border-emerald-100 rounded-xl p-5 bg-emerald-50/20 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={item.label}
                  className={`p-3 ${item.bg} border border-emerald-100 rounded-lg`}
                >
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-medium pt-2">
                {[
                  ...
                  <div
                    key={b.n}
                    className="flex justify-between items-center bg-white px-3 py-2 rounded-lg border border-indigo-100"
                  >
