      ...
      <div className="p-6 flex-1 overflow-y-auto flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {metrics.map((m) => (
            <div
              key={m.label}
              className={`p-4 border rounded-xl flex flex-col justify-between h-24 ${m.color}`}
            >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="text-gray-500 border-b border-gray-100">
                  <tr>
                    <th className="pb-3 font-medium uppercase text-xs">
                      Organization
                    </th>
                    <th className="pb-3 font-medium uppercase text-xs">
                      Industry
                    </th>
                    <th className="pb-3 font-medium uppercase text-xs text-right">
                      Employees
                    </th>
                  </tr>
                </thead>
