  ...
  const categories = [
    {
      ...
      desc: "CPU loads, database status, and delivery errors.",
    },
    {
      id: "subscriptionExpiry",
      label: "Subscription Expiry",
      desc: "Renewal reminders and access freeze warnings.",
    },
    {
      id: "failedPayments",
      label: "Failed Payments",
      desc: "Billing timeouts and card rejections.",
    },
    {
      id: "securityAlerts",
      label: "Security & MFA",
      desc: "Unauthorized logins and permission changes.",
    },
  ] as const;
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex justify-between items-center">
          <span className="text-[10px] text-gray-400 font-medium flex items-center gap-1.5">
            <Info className="w-3.5 h-3.5 text-indigo-500" /> Configurations
            apply platform-wide across all relay engines.
          </span>
          <button
