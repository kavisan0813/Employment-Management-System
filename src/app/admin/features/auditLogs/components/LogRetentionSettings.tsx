...
export function LogRetentionSettings({
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      setSaving(false);
      alert(
        "Retention policies successfully updated in localStorage and active on all routing clusters.",
      );
    }, 600);
  };
      ...
      <div className="px-6 py-5 border-b border-gray-150 bg-gray-50/50 flex items-center justify-between">
        <div>
          ...
          <p className="text-[11px] text-gray-500 mt-1">
            Configure regulatory log storage horizons and secure audit ledger
            behaviors.
          </p>
        </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[11px] text-gray-400">
            Specify how long records are stored in the active system catalog
            before pruning.
          </p>
          <select
            value={retentionDays}
        ...
        <div className="space-y-2">
          ...
          <p className="text-[11px] text-gray-400">
            Applies pre-defined logging structures to match specific industry
            audits.
          </p>
          <select
          ...
          >
            <option value="SOC2">
              SOC2 Type II (Security & Access Ledger)
            </option>
            <option value="ISO27018">
              ISO/IEC 27018 (Cloud Personal Data Protection)
            </option>
        ...
        <div className="flex items-start justify-between gap-4 pt-4 border-t border-gray-100">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-gray-400 max-w-md">
              Automatically package pruned log segments and store them in
              secure, read-only S3 glacier archives.
            </p>
          </div>
        ...
        <div className="flex items-start justify-between gap-4 pt-4 border-t border-gray-100">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-gray-400 max-w-md">
              Prevent any administrative or root command truncation or deletion
              of security and audit trail logs. Once enabled, this control is
              permanently active.
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer mt-1 select-none">
        ...
        {immutableLock && (
          <div className="bg-rose-50 border border-rose-150 p-4 rounded-xl flex gap-3 animate-in fade-in duration-200">
            ...
            <div className="text-xs">
              <h5 className="font-bold text-rose-800">
                Immutable Compliance Mode Active
              </h5>
              <p className="text-rose-700 mt-1 leading-relaxed">
                Platform database ledgers are marked as Write Once Read Many
                (WORM). Administrative commands to prune or delete logs are
                physically rejected on this tenant in accordance with SEC Rule
                17a-4 compliance frameworks.
              </p>
            </div>
          </div>
        )}
