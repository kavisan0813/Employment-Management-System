              ...
              {[
                ...
                return (
                  <div key={s.id} className="relative pl-6 flex items-center">
                    ...
                    <span
                      className={`text-sm font-medium ${active ? "text-indigo-900 font-bold" : completed ? "text-gray-900" : "text-gray-400"}`}
                    >
                      {s.name}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm outline-none focus:border-indigo-500 focus:bg-white transition-colors"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.code}
                      onChange={handleChange}
                      className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm outline-none focus:border-indigo-500 focus:bg-white uppercase"
                      placeholder="ACM001"
                    />
                  </div>
                  <div>
            ...
            {step === 3 && (
              <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                ...
                <div className="bg-blue-50 text-blue-800 p-4 rounded-xl text-xs mb-4">
                  This user will be granted the <strong>Org Admin</strong> role
                  and will receive an email with login instructions.
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2">
                    <label className="block text-xs font-semibold text-gray-700 mb-1.5">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between">
              {step > 1 ? (
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 text-sm transition-colors cursor-pointer"
                >
                  Back
                </button>
              ) : (
              ...
              {step < 4 ? (
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl font-bold text-white bg-emerald-600 hover:bg-emerald-700 text-sm transition-colors shadow-sm flex items-center gap-2 cursor-pointer"
                >
