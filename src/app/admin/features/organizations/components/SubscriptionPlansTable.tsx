...
export function SubscriptionPlansTable() {
  ...
  const plans = activePlans.map((p) => ({
    name: p.name,
    employees:
      p.maxUsers === 99999 ? "Unlimited Employees" : `${p.maxUsers} Employees`,
      ...
      <div className="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-semibold">
            Manage feature sets, pricing tiers, and monitor organization
            subscriptions.
          </p>
        </div>
      </div>
      ...
      <div className="p-6 flex-1 overflow-y-auto flex flex-col gap-12">
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Features and pricing tiers available to tenants.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`relative bg-white rounded-3xl p-8 border ${plan.isPopular ? "border-indigo-500 shadow-xl" : "border-gray-200 shadow-sm"}`}
              >
                {plan.isPopular && (
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Overview of organization subscriptions and lifecycle management.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  {(() => {
                    ...
                    const currentIndex = sortedPlans.findIndex(
                      (p) => p.name === selectedSubscription.plan,
                    );
                    const nextPlan =
                      currentIndex >= 0 && currentIndex < sortedPlans.length - 1
                        ...
                        : null;
                    const prevPlan =
                      currentIndex > 0 ? sortedPlans[currentIndex - 1] : null;
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <button
                        onClick={() =>
                          handleExtend(selectedSubscription.orgId, 1)
                        }
                      ...
                      <button
                        onClick={() =>
                          handleExtend(selectedSubscription.orgId, 6)
                        }
                        className="px-4 py-4 bg-white border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50 rounded-2xl transition-all text-center"
                      >
                      ...
                      <button
                        onClick={() =>
                          handleExtend(selectedSubscription.orgId, 12)
                        }
                        className="px-4 py-4 bg-white border border-gray-200 hover:border-emerald-200 hover:bg-emerald-50 rounded-2xl transition-all text-center"
                      >
