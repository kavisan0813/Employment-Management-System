...
import { Monitor, MapPin, AlertTriangle, Slash, LogOut, X } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="px-5 py-4 space-y-0.5">
              <InfoRow
                ...
                value={`${selectedSession.device} \u2022 ${selectedSession.browser}`}
              />
              <InfoRow label="IP Address" value={selectedSession.ipAddress} />
              <InfoRow
                label="Login Time"
                value={new Date(selectedSession.loginTime).toLocaleString()}
              />
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-200 flex flex-wrap gap-2">
            <button
              onClick={() => {
                alert(`Location: ${selectedSession.ipAddress}`);
            ...
            <button
              onClick={() => {
                alert(`Marking session ${selectedSession.id} as suspicious...`);
                setIsDrawerOpen(false);
              }}
            ...
            <button
              onClick={() => {
                alert(`Device ${selectedSession.device} blocked.`);
                setIsDrawerOpen(false);
              }}
            ...
            {selectedSession.status === "Active" && (
              <button
                onClick={() => {
                  actions.killSession(selectedSession.id);
                  setIsDrawerOpen(false);
                }}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50/50 border-b border-gray-100 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  ...
                  <th className="px-5 py-4 text-center rounded-tr-2xl">
                    Status
                  </th>
                </tr>
              </thead>
