      ...
      <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4" onClick={() => setIsDrawerOpen(false)}>
        ...
        >
          ...
          <div className="px-8 py-6 border-b flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Super Admin Profile</h2>
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-8">
            <div className="grid grid-cols-2 gap-6 text-sm">
              ...
              <div>
                <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-1">Specific Role</p>
                <p className="font-semibold text-indigo-600">{selectedAdmin.role}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <span className={`inline-flex items-center px-4 py-1.5 rounded-full text-sm font-bold ${
                selectedAdmin.status === 'Active' ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700'
              }`}>
            ...
            <div className="pt-6 border-t">
              <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-4">Manage Access</p>
