...
export const RECENT_ACTIVITY = [
  {
    label: "Acme Corp upgraded to Enterprise",
    time: "2m ago",
    colorVar: "var(--chart-1)",
  },
  {
    label: "New org: Bright Labs registered",
    time: "14m ago",
    colorVar: "var(--chart-2)",
  },
  {
    label: "Orbit Systems payment failed",
    time: "1h ago",
  ...
  {
    label: "API rate limit increased for viyan",
    time: "3h ago",
