...
function assignTeam(content) {
  return content.replace(/department:\s*['\"]([^'\"]+)['\"]/g, (match, deptName) => {
...
const mockDataPath = 'd:/EMS Admin/Employment-Management-System/src/app/data/mockData.ts';
let mockData = fs.readFileSync(mockDataPath, 'utf8');
fs.writeFileSync(mockDataPath, assignTeam(mockData));

const empDirPath = 'd:/EMS Admin/Employment-Management-System/src/app/pages/employee/EmployeeDirectory.tsx';
